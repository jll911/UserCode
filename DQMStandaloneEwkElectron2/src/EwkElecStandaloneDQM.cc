...
EwkElecStandaloneDQM::EwkElecStandaloneDQM( const ParameterSet & cfg ) :
  ...
  //  isData_(cfg.getUntrackedParameter<bool>("IsData",false)),
  ...
  wpIndex_(cfg.getUntrackedParameter<int>("wpIndex",0))

{

  //  std::cout << "Using WP index of " << wpIndex_ << std::endl;
...
//       tree_->Branch("l1TriggersResults_",l1TriggersResults_,"l1TriggersResults_/O"); 
      ...
      tree_->Branch("ele_scet",ele_scet_,"ele_scet[ele_nelectrons]/F");
      ...
      tree_->Branch("ele_nexpectedinnerhits",ele_nexpectedinnerhits_,"ele_nexpectedinnerhits[ele_nelectrons]/I");
      tree_->Branch("ele_dcottheta",ele_dcottheta_,"ele_dcottheta[ele_nelectrons]/F");
      tree_->Branch("ele_dist",ele_dist_,"ele_dist[ele_nelectrons]/F");
      ...
      // trigger objects
      // HLT objects
      tree_->Branch("hlt_nHltObj_Elec10",&hlt_nHltObj_Elec10_,"hlt_nHltObj_Elec10/i");
      tree_->Branch("hlt_nHltObj_Elec15",&hlt_nHltObj_Elec15_,"hlt_nHltObj_Elec15/i");
      tree_->Branch("hlt_nHltObj_Phot10",&hlt_nHltObj_Phot10_,"hlt_nHltObj_Phot10/i");
      tree_->Branch("hlt_nHltObj_Phot15",&hlt_nHltObj_Phot15_,"hlt_nHltObj_Phot15/i");
      //      tree_->Branch("hlt_nHltTrig",&hlt_nHltTrig_,"k_nHltTrig/i");
//       tree_->Branch("hlt_et",hlt_et_,"hlt_et_[n_HltTrig][hlt_nHltObj]/F");
//       tree_->Branch("hlt_eta",hlt_eta_,"hlt_eta_[n_HltTrig][hlt_nHltObj]/F");
//       tree_->Branch("hlt_phi",hlt_phi_,"hlt_phi_[n_HltTrig][hlt_nHltObj]/F");

      tree_->Branch("hlt_Elec10_et",hlt_Elec10_et_,"hlt_Elec10_et[hlt_nHltObj_Elec10]/F");
      tree_->Branch("hlt_Elec10_eta",hlt_Elec10_eta_,"hlt_Elec10_eta[hlt_nHltObj_Elec10]/F");
      tree_->Branch("hlt_Elec10_phi",hlt_Elec10_phi_,"hlt_Elec10_phi[hlt_nHltObj_Elec10]/F");
      tree_->Branch("hlt_Elec15_et",hlt_Elec15_et_,"hlt_Elec15_et[hlt_nHltObj_Elec15]/F");
      tree_->Branch("hlt_Elec15_eta",hlt_Elec15_eta_,"hlt_Elec15_eta[hlt_nHltObj_Elec15]/F");
      tree_->Branch("hlt_Elec15_phi",hlt_Elec15_phi_,"hlt_Elec15_phi[hlt_nHltObj_Elec15]/F");
      tree_->Branch("hlt_Phot10_et",hlt_Phot10_et_,"hlt_Phot10_et[hlt_nHltObj_Phot10]/F");
      tree_->Branch("hlt_Phot10_eta",hlt_Phot10_eta_,"hlt_Phot10_eta[hlt_nHltObj_Phot10]/F");
      tree_->Branch("hlt_Phot10_phi",hlt_Phot10_phi_,"hlt_Phot10_phi[hlt_nHltObj_Phot10]/F");
      tree_->Branch("hlt_Phot15_et",hlt_Phot15_et_,"hlt_Phot15_et[hlt_nHltObj_Phot15]/F");
      tree_->Branch("hlt_Phot15_eta",hlt_Phot15_eta_,"hlt_Phot15_eta[hlt_nHltObj_Phot15]/F");
      tree_->Branch("hlt_Phot15_phi",hlt_Phot15_phi_,"hlt_Phot15_phi[hlt_nHltObj_Phot15]/F");

      //L1 objects
      tree_->Branch("l1_nL1Obj",&l1_nL1Obj_,"l1_nL1Obj/i");
//       tree_->Branch("l1_et",l1_et_,"l1_et_[k_L1TRIG][l1_nL1Obj_]/F");
//       tree_->Branch("l1_eta",l1_eta_,"l1_eta_[k_L1TRIG][l1_nL1Obj_]/F");
//       tree_->Branch("l1_phi",l1_phi_,"l1_phi_[k_L1TRIG][l1_nL1Obj_]/F");
      tree_->Branch("l1_et",l1_et_,"l1_et[l1_nL1Obj]/F");
      tree_->Branch("l1_eta",l1_eta_,"l1_eta[l1_nL1Obj]/F");
      tree_->Branch("l1_phi",l1_phi_,"l1_phi[l1_nL1Obj]/F");
      ...
      tree_->Branch("sc_et",sc_eta_,"sc_et[sc_nSuperClusters]/F");
  ...
  // the denominator for all the efficiency plots!
...
//   trg_trig_after_ = fs->make<TH1F>("ELE_TRIG_LASTCUT",chtitle.data(),2,-0.5,1.5);
  ...
  plotString = "response vs. electron E_{T} for HLT_Photon20_L1R, good electrons only;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Photon20_L1R_eff_goodEle_ = fs->make<TH1F>("TRG_HLT_PHOTON20_L1R_EFF_GOODELE",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron E_{T} for HLT_Photon30_L1R, good electrons only;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  ...
  plotString = "response vs. electron E_{T} for L1_SingleIsoEG5, good electrons only;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleIsoEG5_eff_goodEle_ = fs->make<TH1F>("TRG_L1_SINGLEISOEG5_EFF_GOODELE",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron E_{T} for L1_SingleIsoEG8, good electrons only;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleIsoEG8_eff_goodEle_ = fs->make<TH1F>("TRG_L1_SINGLEISOEG8_EFF_GOODELE",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron E_{T} for L1_SingleIsoEG10, good electrons only;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleIsoEG10_eff_goodEle_ = fs->make<TH1F>("TRG_L1_SINGLEISOEG10_EFF_GOODELE",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron E_{T} for L1_SingleIsoEG12, good electrons only;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleIsoEG12_eff_goodEle_ = fs->make<TH1F>("TRG_L1_SINGLEISOEG12_EFF_GOODELE",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron E_{T} for L1_SingleIsoEG15, good electrons only;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleIsoEG15_eff_goodEle_ = fs->make<TH1F>("TRG_L1_SINGLEISOEG15_EFF_GOODELE",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron E_{T} for L1_SingleEG2, good electrons only;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  ...
  plotString = "response vs. electron E_{T} for L1_SingleEG8, good electrons only;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG8_eff_goodEle_ = fs->make<TH1F>("TRG_L1_SINGLEEG8_EFF_GOODELE",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron E_{T} for L1_SingleEG10, good electrons only;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG10_eff_goodEle_ = fs->make<TH1F>("TRG_L1_SINGLEEG10_EFF_GOODELE",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron E_{T} for L1_SingleEG12, good electrons only;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG12_eff_goodEle_ = fs->make<TH1F>("TRG_L1_SINGLEEG12_EFF_GOODELE",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron E_{T} for L1_SingleEG15, good electrons only;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG15_eff_goodEle_ = fs->make<TH1F>("TRG_L1_SINGLEEG15_EFF_GOODELE",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron E_{T} for L1_SingleEG20, good electrons only;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  ...
  // ELECTRONS with SUPERCLUSTER ET

  plotString = "response vs. electron SC E_{T} denominator;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_Denominator_eff_eleSC_ = fs->make<TH1F>("TRG_DENOMINATOR_EFF_ELESC",chtitle.data(),60,0.,60.);

  // electron
  plotString = "response vs. electron SC E_{T} for HLT_L1SINGLEEG5;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_L1SingleEG5_eff_eleSC_ = fs->make<TH1F>("TRG_HLT_L1SINGLEEG5_EFF_ELESC",chtitle.data(),60,0.,60.);
//   chtitle = collName+"after N-1 cuts: "+plotString;
//   trg_trig_after_ = fs->make<TH1F>("ELE_TRIG_LASTCUT",chtitle.data(),2,-0.5,1.5);

  plotString = "response vs. electron SC E_{T} for HLT_L1SINGLEEG8;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_L1SingleEG8_eff_eleSC_ = fs->make<TH1F>("TRG_HLT_L1SINGLEEG8_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for HLT_Ele10_LW_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Ele10_LW_L1R_eff_eleSC_ = fs->make<TH1F>("TRG_HLT_ELE10_LW_L1R_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for HLT_Ele10_LW_EleId_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Ele10_LW_EleId_L1R_eff_eleSC_ = fs->make<TH1F>("TRG_HLT_ELE10_LW_ELEID_L1R_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for HLT_Ele15_LW_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Ele15_LW_L1R_eff_eleSC_ = fs->make<TH1F>("TRG_HLT_ELE15_LW_L1R_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for HLT_Ele15_SiStrip_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Ele15_SiStrip_L1R_eff_eleSC_ = fs->make<TH1F>("TRG_HLT_ELE15_SISTRIP_L1R_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for HLT_Ele20_LW_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Ele20_LW_L1R_eff_eleSC_ = fs->make<TH1F>("TRG_HLT_ELE20_LW_L1R_EFF_ELESC",chtitle.data(),60,0.,60.);


  // photon  
  plotString = "response vs. electron SC E_{T} for HLT_Photon10_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Photon10_L1R_eff_eleSC_ = fs->make<TH1F>("TRG_HLT_PHOTON10_L1R_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for HLT_Photon15_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Photon15_L1R_eff_eleSC_ = fs->make<TH1F>("TRG_HLT_PHOTON15_L1R_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for HLT_Photon15_TrackIso_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Photon15_TrackIso_L1R_eff_eleSC_ = fs->make<TH1F>("TRG_HLT_PHOTON15_TRACKISO_L1R_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for HLT_Photon15_LooseEcalIso_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Photon15_LooseEcalIso_L1R_eff_eleSC_ = fs->make<TH1F>("TRG_HLT_PHOTON15_LOOSEECALISO_L1R_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for HLT_Photon20_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Photon20_L1R_eff_eleSC_ = fs->make<TH1F>("TRG_HLT_PHOTON20_L1R_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for HLT_Photon30_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Photon30_L1R_eff_eleSC_ = fs->make<TH1F>("TRG_HLT_PHOTON30_L1R_EFF_ELESC",chtitle.data(),60,0.,60.);


  // L1 triggers

  plotString = "response vs. electron SC E_{T} for L1_SingleIsoEG5;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleIsoEG5_eff_eleSC_ = fs->make<TH1F>("TRG_L1_SINGLEISOEG5_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for L1_SingleIsoEG8;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleIsoEG8_eff_eleSC_ = fs->make<TH1F>("TRG_L1_SINGLEISOEG8_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for L1_SingleIsoEG10;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleIsoEG10_eff_eleSC_ = fs->make<TH1F>("TRG_L1_SINGLEISOEG10_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for L1_SingleIsoEG12;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleIsoEG12_eff_eleSC_ = fs->make<TH1F>("TRG_L1_SINGLEISOEG12_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for L1_SingleIsoEG15;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleIsoEG15_eff_eleSC_ = fs->make<TH1F>("TRG_L1_SINGLEISOEG15_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for L1_SingleEG2;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG2_eff_eleSC_ = fs->make<TH1F>("TRG_L1_SINGLEEG2_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for L1_SingleEG5;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG5_eff_eleSC_ = fs->make<TH1F>("TRG_L1_SINGLEEG5_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for L1_SingleEG8;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG8_eff_eleSC_ = fs->make<TH1F>("TRG_L1_SINGLEEG8_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for L1_SingleEG10;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG10_eff_eleSC_ = fs->make<TH1F>("TRG_L1_SINGLEEG10_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for L1_SingleEG12;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG12_eff_eleSC_ = fs->make<TH1F>("TRG_L1_SINGLEEG12_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for L1_SingleEG15;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG15_eff_eleSC_ = fs->make<TH1F>("TRG_L1_SINGLEEG15_EFF_ELESC",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron SC E_{T} for L1_SingleEG20;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG20_eff_eleSC_ = fs->make<TH1F>("TRG_L1_SINGLEEG20_EFF_ELESC",chtitle.data(),60,0.,60.);
  ...
  plotString = "response vs. SC E_{T} denominator;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_Denominator_eff_SC_ = fs->make<TH1F>("TRG_DENOMINATOR_EFF_SC",chtitle.data(),60,0.,60.);

  // electron
  plotString = "response vs. SC E_{T} for HLT_L1SINGLEEG5;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_L1SingleEG5_eff_SC_ = fs->make<TH1F>("TRG_HLT_L1SINGLEEG5_EFF_SC",chtitle.data(),60,0.,60.);
//   chtitle = collName+"after N-1 cuts: "+plotString;
//   trg_trig_after_ = fs->make<TH1F>("ELE_TRIG_LASTCUT",chtitle.data(),2,-0.5,1.5);

  plotString = "response vs. SC E_{T} for HLT_L1SINGLEEG8;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_L1SingleEG8_eff_SC_ = fs->make<TH1F>("TRG_HLT_L1SINGLEEG8_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for HLT_Ele10_LW_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Ele10_LW_L1R_eff_SC_ = fs->make<TH1F>("TRG_HLT_ELE10_LW_L1R_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for HLT_Ele10_LW_EleId_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Ele10_LW_EleId_L1R_eff_SC_ = fs->make<TH1F>("TRG_HLT_ELE10_LW_ELEID_L1R_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for HLT_Ele15_LW_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Ele15_LW_L1R_eff_SC_ = fs->make<TH1F>("TRG_HLT_ELE15_LW_L1R_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for HLT_Ele15_SiStrip_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Ele15_SiStrip_L1R_eff_SC_ = fs->make<TH1F>("TRG_HLT_ELE15_SISTRIP_L1R_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for HLT_Ele20_LW_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Ele20_LW_L1R_eff_SC_ = fs->make<TH1F>("TRG_HLT_ELE20_LW_L1R_EFF_SC",chtitle.data(),60,0.,60.);


  // photon  
  plotString = "response vs. SC E_{T} for HLT_Photon10_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Photon10_L1R_eff_SC_ = fs->make<TH1F>("TRG_HLT_PHOTON10_L1R_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for HLT_Photon15_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Photon15_L1R_eff_SC_ = fs->make<TH1F>("TRG_HLT_PHOTON15_L1R_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for HLT_Photon15_TrackIso_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Photon15_TrackIso_L1R_eff_SC_ = fs->make<TH1F>("TRG_HLT_PHOTON15_TRACKISO_L1R_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for HLT_Photon15_LooseEcalIso_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Photon15_LooseEcalIso_L1R_eff_SC_ = fs->make<TH1F>("TRG_HLT_PHOTON15_LOOSEECALISO_L1R_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for HLT_Photon20_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Photon20_L1R_eff_SC_ = fs->make<TH1F>("TRG_HLT_PHOTON20_L1R_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for HLT_Photon30_L1R;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_HLT_Photon30_L1R_eff_SC_ = fs->make<TH1F>("TRG_HLT_PHOTON30_L1R_EFF_SC",chtitle.data(),60,0.,60.);


  // L1 triggers

  plotString = "response vs. SC E_{T} for L1_SingleIsoEG5;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleIsoEG5_eff_SC_ = fs->make<TH1F>("TRG_L1_SINGLEISOEG5_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for L1_SingleIsoEG8;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleIsoEG8_eff_SC_ = fs->make<TH1F>("TRG_L1_SINGLEISOEG8_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for L1_SingleIsoEG10;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleIsoEG10_eff_SC_ = fs->make<TH1F>("TRG_L1_SINGLEISOEG10_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for L1_SingleIsoEG12;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleIsoEG12_eff_SC_ = fs->make<TH1F>("TRG_L1_SINGLEISOEG12_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for L1_SingleIsoEG15;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleIsoEG15_eff_SC_ = fs->make<TH1F>("TRG_L1_SINGLEISOEG15_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for L1_SingleEG2;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG2_eff_SC_ = fs->make<TH1F>("TRG_L1_SINGLEEG2_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for L1_SingleEG5;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG5_eff_SC_ = fs->make<TH1F>("TRG_L1_SINGLEEG5_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for L1_SingleEG8;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG8_eff_SC_ = fs->make<TH1F>("TRG_L1_SINGLEEG8_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for L1_SingleEG10;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG10_eff_SC_ = fs->make<TH1F>("TRG_L1_SINGLEEG10_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for L1_SingleEG12;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG12_eff_SC_ = fs->make<TH1F>("TRG_L1_SINGLEEG12_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for L1_SingleEG15;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG15_eff_SC_ = fs->make<TH1F>("TRG_L1_SINGLEEG15_EFF_SC",chtitle.data(),60,0.,60.);

  plotString = "response vs. SC E_{T} for L1_SingleEG20;E_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG20_eff_SC_ = fs->make<TH1F>("TRG_L1_SINGLEEG20_EFF_SC",chtitle.data(),60,0.,60.);
  ...
  /////////////////// special
  plotString = "electron p_{T} vs triggers fired;p_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_highestEtVsThreshold_ = fs->make<TH2F>("TRG_HIGHESTETVSTHRESHOLD",chtitle.data(),20,0.,20.,60,0.,60.);

  plotString = "response vs. electron p_{T} for L1_SingleEG5: not fired because result = false;p_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG5_eff_notfire1_ = fs->make<TH1F>("TRG_L1_SINGLEEG5_EFF_NOTFIRE1",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron p_{T} for L1_SingleEG5: not fired because trigger not in triggersOfInterest;p_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG5_eff_notfire2_ = fs->make<TH1F>("TRG_L1_SINGLEEG5_EFF_NOTFIRE2",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron p_{T} for L1_SingleEG5, barrel-only;p_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  ...
  plotString = "response vs. electron p_{T} for L1_SingleEG5, ECAL-driven electrons only;p_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  ...
  plotString = "response vs. electron #eta for L1_SingleEG5 (for electrons with p_{T} > 5 Gev);#eta;"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG5_eff_eta_cutPt5_ = fs->make<TH1F>("TRG_L1_SINGLEEG5_EFF_ETA_CUTPT5",chtitle.data(),64,-3.2,3.2);

  plotString = "response vs. electron #eta for L1_SingleEG5 (for electrons with p_{T} > 5 Gev);#eta;"; 
  chtitle = "Trigger: "+plotString;
  h_trg_Denominator_eff_eta_cutPt5_ = fs->make<TH1F>("TRG_DENOMINATOR_EFF_ETA_CUTPT5",chtitle.data(),64,-3.2,3.2);
  ...
  // pt and eta
  plotString = "eff of #eta and electron p_{T} denominator;#eta;p_{T} (GeV)"; 
  chtitle = "Trigger: "+plotString;
  h_trg_Denominator_eff_etaPt_ = fs->make<TH2F>("TRG_DENOMINATOR_EFF_ETAPT",chtitle.data(),64,-3.2,3.2,60,0.,60.);

  plotString = "eff of #eta and electron p_{T} for L1_SingleEG5;#eta;p_{T} (GeV)"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG5_eff_etaPt_ = fs->make<TH2F>("TRG_L1_SINGLEEG5_EFF_ETAPT",chtitle.data(),64,-3.2,3.2,60,0.,60.);
  ///////////////////////end special

  plotString = "response vs. electron p_{T} for L1_SingleEG8;p_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG8_eff_ = fs->make<TH1F>("TRG_L1_SINGLEEG8_EFF",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron p_{T} for L1_SingleEG10;p_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG10_eff_ = fs->make<TH1F>("TRG_L1_SINGLEEG10_EFF",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron p_{T} for L1_SingleEG12;p_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG12_eff_ = fs->make<TH1F>("TRG_L1_SINGLEEG12_EFF",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron p_{T} for L1_SingleEG15;p_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  h_trg_L1_SingleEG15_eff_ = fs->make<TH1F>("TRG_L1_SINGLEEG15_EFF",chtitle.data(),60,0.,60.);

  plotString = "response vs. electron p_{T} for L1_SingleEG20;p_{T} (GeV);"; 
  chtitle = "Trigger: "+plotString;
  ...
  plotString = "SC E_{T};E_{T} (GeV);";
  chtitle = collName+"before cuts: "+plotString;
  h_ele_scet_before_ = fs->make<TH1F>("ELE_SCET_BEFORECUTS",chtitle.data(),100,0.,100.);
  chtitle = collName+"after cuts: "+plotString;
  h_ele_scet_after_ = fs->make<TH1F>("ELE_SCET_AFTERCUTS",chtitle.data(),100,0.,100.);
  ...
  // number of expected (missing) inner hits
  plotString = "Number of expected inner hits;n expected hits;";
  chtitle = collName+"before cuts: "+plotString;
  h_ele_nExpectedInnerHits_before_ = fs->make<TH1F>("ELE_NEXPECTEDINNERHITS_BEFORECUTS",chtitle.data(),10,0.,10.);
  chtitle = collName+"after cuts: "+plotString;
  h_ele_nExpectedInnerHits_after_ = fs->make<TH1F>("ELE_NEXPECTEDINNERHITS_AFTERCUTS",chtitle.data(),10,0.,10.);

  // delta cot theta
  plotString = "#deltacot#theta;#deltacot#theta;";
  chtitle = collName+"before cuts: "+plotString;
  h_ele_dcotTheta_before_ = fs->make<TH1F>("ELE_DCOTTHETA_BEFORECUTS",chtitle.data(),50,0.,0.1);
  chtitle = collName+"after cuts: "+plotString;
  h_ele_dcotTheta_after_ = fs->make<TH1F>("ELE_DCOTTHETA_AFTERCUTS",chtitle.data(),50,0.,0.1);

  // "Dist"
  plotString = "Dist;Dist;";
  chtitle = collName+"before cuts: "+plotString;
  h_ele_dist_before_ = fs->make<TH1F>("ELE_DIST_BEFORECUTS",chtitle.data(),50,0.,0.1);
  chtitle = collName+"after cuts: "+plotString;
  h_ele_dist_after_ = fs->make<TH1F>("ELE_DIST_AFTERCUTS",chtitle.data(),50,0.,0.1);
...
//   h_ele_zBS_after_ = fs->make<TH1F>("ELE_ZBS_AFTERCUTS",chtitle.data(),50,-25.,25.);
  ...
  // entries passing working point

  nEvents_spike_Barrel_ScEt_ = fs->make<TH1F>("nEvents_spike_Barrel_ScEt","Electron SC E_{T} after spike rejection, barrel-only;Electron SC E_{T};",60,0.,60.);
  nEvents_combIso_Barrel_ScEt_ = fs->make<TH1F>("nEvents_combIso_Barrel_ScEt","Electron SC E_{T} after isolation cut, barrel-only;Electron SC E_{T};",60,0.,60.);
  nEvents_missHits_Barrel_ScEt_ = fs->make<TH1F>("nEvents_missHits_Barrel_ScEt","Electron SC E_{T} after nMissHits cut, barrel-only;Electron SC E_{T};",60,0.,60.);
  nEvents_dist_Barrel_ScEt_ = fs->make<TH1F>("nEvents_dist_Barrel_ScEt","Electron SC E_{T} after dist cut, barrel-only;Electron SC E_{T};",60,0.,60.);
  nEvents_dCotTheta_Barrel_ScEt_ = fs->make<TH1F>("nEvents_dCotTheta_Barrel_ScEt","Electron SC E_{T} after #deltacot#theta cut, barrel-only;Electron SC E_{T};",60,0.,60.);
  nEvents_sieie_Barrel_ScEt_ = fs->make<TH1F>("nEvents_sieie_Barrel_ScEt","Electron SC E_{T} after #sigma_{i#etai#eta} cut, barrel-only;Electron SC E_{T};",60,0.,60.);
  nEvents_dphiin_Barrel_ScEt_ = fs->make<TH1F>("nEvents_dphiin_Barrel_ScEt","Electron SC E_{T} after #delta#phi_{in} cut, barrel-only;Electron SC E_{T};",60,0.,60.);
  nEvents_detain_Barrel_ScEt_ = fs->make<TH1F>("nEvents_detain_Barrel_ScEt","Electron SC E_{T} after #delta#eta_{in} cut, barrel-only;Electron SC E_{T};",60,0.,60.);
  nEvents_hoe_Barrel_ScEt_ = fs->make<TH1F>("nEvents_hoe_Barrel_ScEt","Electron SC E_{T} after H/E cut, barrel-only;Electron SC E_{T};",60,0.,60.);

  nEvents_spike_Endcap_ScEt_ = fs->make<TH1F>("nEvents_spike_Endcap_ScEt","Electron SC E_{T} after spike rejection, endcap-only;Electron SC E_{T};",60,0.,60.);
  nEvents_combIso_Endcap_ScEt_ = fs->make<TH1F>("nEvents_combIso_Endcap_ScEt","Electron SC E_{T} after isolation cut, endcap-only;Electron SC E_{T};",60,0.,60.);
  nEvents_missHits_Endcap_ScEt_ = fs->make<TH1F>("nEvents_missHits_Endcap_ScEt","Electron SC E_{T} after nMissHits cut, endcap-only;Electron SC E_{T};",60,0.,60.);
  nEvents_dist_Endcap_ScEt_ = fs->make<TH1F>("nEvents_dist_Endcap_ScEt","Electron SC E_{T} after dist cut, endcap-only;Electron SC E_{T};",60,0.,60.);
  nEvents_dCotTheta_Endcap_ScEt_ = fs->make<TH1F>("nEvents_dCotTheta_Endcap_ScEt","Electron SC E_{T} after #deltacot#theta cut, endcap-only;Electron SC E_{T};",60,0.,60.);
  nEvents_sieie_Endcap_ScEt_ = fs->make<TH1F>("nEvents_sieie_Endcap_ScEt","Electron SC E_{T} after #sigma_{i#etai#eta} cut, endcap-only;Electron SC E_{T};",60,0.,60.);
  nEvents_dphiin_Endcap_ScEt_ = fs->make<TH1F>("nEvents_dphiin_Endcap_ScEt","Electron SC E_{T} after #delta#phi_{in} cut, endcap-only;Electron SC E_{T};",60,0.,60.);
  nEvents_detain_Endcap_ScEt_ = fs->make<TH1F>("nEvents_detain_Endcap_ScEt","Electron SC E_{T} after #delta#eta_{in} cut, endcap-only;Electron SC E_{T};",60,0.,60.);
  nEvents_hoe_Endcap_ScEt_ = fs->make<TH1F>("nEvents_hoe_Endcap_ScEt","Electron SC E_{T} after H/E cut, endcap-only;Electron SC E_{T};",60,0.,60.);


  // efficiencies copied from ewkdqmtree

  // barrel, ecal, match, vs elec SC ET
  eff_denom_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, barrel, ECAL-driven, trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel, ECAL-driven, trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel, ECAL-driven, trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel, ECAL-driven, trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel, ECAL-driven, trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, barrel, ECAL-driven, trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, barrel, ECAL-driven, trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // barrel, ecal, match, vs eta
  eff_denom_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ETA_","elec #eta, barrel, ECAL-driven, trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel, ECAL-driven, trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel, ECAL-driven, trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel, ECAL-driven, trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel, ECAL-driven, trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, barrel, ECAL-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, barrel, ECAL-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // barrel, ecal, non-match, vs elec SC ET
  eff_denom_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, barrel, ECAL-driven, non-trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel, ECAL-driven, non-trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel, ECAL-driven, non-trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel, ECAL-driven, non-trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel, ECAL-driven, non-trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, barrel, ECAL-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, barrel, ECAL-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // barrel, ecal, non-match, vs eta
  eff_denom_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ETA_","elec #eta, barrel, ECAL-driven, non-trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel, ECAL-driven, non-trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel, ECAL-driven, non-trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel, ECAL-driven, non-trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel, ECAL-driven, non-trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, barrel, ECAL-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, barrel, ECAL-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // barrel, tracker, match, vs elec SC ET
  eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, barrel, tracker-driven, non-trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // barrel, tracker, match, vs eta
  eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ETA_","elec #eta, barrel, tracker-driven, trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel, tracker-driven, trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel, tracker-driven, trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel, tracker-driven, trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel, tracker-driven, trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, barrel, tracker-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, barrel, tracker-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // barrel, tracker, non-match, vs elec SC ET
  eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, barrel, tracker-driven, non-trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // barrel, tracker, non-match, vs eta
  eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA_","elec #eta, barrel, tracker-driven, non-trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel, tracker-driven, non-trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel, tracker-driven, non-trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel, tracker-driven, non-trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel, tracker-driven, non-trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, barrel, tracker-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, barrel, tracker-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // barrel, ecal+tracker, match, vs elec SC ET
  eff_denom_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, barrel, ecal+tracker-driven, trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // barrel, ecal+tracker, match, vs eta
  eff_denom_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ETA_","elec #eta, barrel, ecal+tracker-driven, trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel, ecal+tracker-driven, trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel, ecal+tracker-driven, trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel, ecal+tracker-driven, trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel, ecal+tracker-driven, trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, barrel, ecal+tracker-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, barrel, ecal+tracker-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // barrel, ecal+tracker, non-match, vs elec SC ET
  eff_denom_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, barrel, ecal+tracker-driven, non-trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, non-trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, non-trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, non-trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, non-trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // barrel, ecal+tracker, non-match, vs eta
  eff_denom_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ETA_"      ,"elec #eta, barrel, ecal+tracker-driven, non-trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel, ecal+tracker-driven, non-trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel, ecal+tracker-driven, non-trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel, ecal+tracker-driven, non-trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel, ecal+tracker-driven, non-trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, barrel, ecal+tracker-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, barrel, ecal+tracker-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // endcap, ecal, match, vs elec SC ET
  eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, endcap, ECAL-driven, trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, endcap, ECAL-driven, trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, endcap, ECAL-driven, trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, endcap, ECAL-driven, trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, endcap, ECAL-driven, trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, endcap, ECAL-driven, trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, endcap, ECAL-driven, trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // endcap, ecal, match, vs eta
  eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ETA_","elec #eta, endcap, ECAL-driven, trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, endcap, ECAL-driven, trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, endcap, ECAL-driven, trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, endcap, ECAL-driven, trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, endcap, ECAL-driven, trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, endcap, ECAL-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, endcap, ECAL-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // endcap, ecal, non-match, vs elec SC ET
  eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, endcap, ECAL-driven, non-trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, endcap, ECAL-driven, non-trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, endcap, ECAL-driven, non-trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, endcap, ECAL-driven, non-trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, endcap, ECAL-driven, non-trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, endcap, ECAL-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, endcap, ECAL-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // endcap, ecal, non-match, vs eta
  eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ETA_","elec #eta, endcap, ECAL-driven, non-trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, endcap, ECAL-driven, non-trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, endcap, ECAL-driven, non-trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, endcap, ECAL-driven, non-trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, endcap, ECAL-driven, non-trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, endcap, ECAL-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, endcap, ECAL-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // endcap, tracker, match, vs elec SC ET
  eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, endcap, tracker-driven, non-trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // endcap, tracker, match, vs eta
  eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ETA_","elec #eta, endcap, tracker-driven, trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, endcap, tracker-driven, trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, endcap, tracker-driven, trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, endcap, tracker-driven, trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, endcap, tracker-driven, trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, endcap, tracker-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, endcap, tracker-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // endcap, tracker, non-match, vs elec SC ET
  eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, endcap, tracker-driven, non-trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // endcap, tracker, non-match, vs eta
  eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA_","elec #eta, endcap, tracker-driven, non-trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, endcap, tracker-driven, non-trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, endcap, tracker-driven, non-trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, endcap, tracker-driven, non-trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, endcap, tracker-driven, non-trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, endcap, tracker-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, endcap, tracker-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // endcap, ecal+tracker, match, vs elec SC ET
  eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, endcap, ecal+tracker-driven, trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // endcap, ecal+tracker, match, vs eta
  eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ETA_","elec #eta, endcap, ecal+tracker-driven, trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, endcap, ecal+tracker-driven, trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, endcap, ecal+tracker-driven, trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, endcap, ecal+tracker-driven, trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, endcap, ecal+tracker-driven, trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, endcap, ecal+tracker-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, endcap, ecal+tracker-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // endcap, ecal+tracker, non-match, vs elec SC ET
  eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, endcap, ecal+tracker-driven, non-trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, non-trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, non-trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, non-trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, non-trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // endcap, ecal+tracker, non-match, vs eta
  eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ETA_"      ,"elec #eta, endcap, ecal+tracker-driven, non-trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, endcap, ecal+tracker-driven, non-trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, endcap, ecal+tracker-driven, non-trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, endcap, ecal+tracker-driven, non-trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, endcap, ecal+tracker-driven, non-trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, endcap, ecal+tracker-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, endcap, ecal+tracker-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // barrel+endcap, ecal, match, vs elec SC ET
  eff_denom_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, barrel+endcap, ECAL-driven, trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // barrel+endcap, ecal, match, vs eta
  eff_denom_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ETA_","elec #eta, barrel+endcap, ECAL-driven, trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel+endcap, ECAL-driven, trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel+endcap, ECAL-driven, trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel+endcap, ECAL-driven, trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel+endcap, ECAL-driven, trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, barrel+endcap, ECAL-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, barrel+endcap, ECAL-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // barrel+endcap, ecal, non-match, vs elec SC ET
  eff_denom_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, barrel+endcap, ECAL-driven, non-trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, non-trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, non-trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, non-trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, non-trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // barrel+endcap, ecal, non-match, vs eta
  eff_denom_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ETA_","elec #eta, barrel+endcap, ECAL-driven, non-trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel+endcap, ECAL-driven, non-trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel+endcap, ECAL-driven, non-trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel+endcap, ECAL-driven, non-trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel+endcap, ECAL-driven, non-trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, barrel+endcap, ECAL-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, barrel+endcap, ECAL-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // barrel+endcap, tracker, match, vs elec SC ET
  eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // barrel+endcap, tracker, match, vs eta
  eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ETA_","elec #eta, barrel+endcap, tracker-driven, trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel+endcap, tracker-driven, trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel+endcap, tracker-driven, trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel+endcap, tracker-driven, trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel+endcap, tracker-driven, trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, barrel+endcap, tracker-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, barrel+endcap, tracker-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // barrel+endcap, tracker, non-match, vs elec SC ET
  eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // barrel+endcap, tracker, non-match, vs eta
  eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA_","elec #eta, barrel+endcap, tracker-driven, non-trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel+endcap, tracker-driven, non-trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel+endcap, tracker-driven, non-trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel+endcap, tracker-driven, non-trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel+endcap, tracker-driven, non-trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, barrel+endcap, tracker-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, barrel+endcap, tracker-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // barrel+endcap, ecal+tracker, match, vs elec SC ET
  eff_denom_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, barrel+endcap, ecal+tracker-driven, trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // barrel+endcap, ecal+tracker, match, vs eta
  eff_denom_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ETA_","elec #eta, barrel+endcap, ecal+tracker-driven, trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);

  // barrel+endcap, ecal+tracker, non-match, vs elec SC ET
  eff_denom_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET_","elec SC E_{T}, barrel+endcap, ecal+tracker-driven, non-trig-matched;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, non-trig-matched, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, non-trig-matched, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, non-trig-matched, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, non-trig-matched, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG5_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET__L1_EG8_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);

  // barrel+endcap, ecal+tracker, non-match, vs eta
  eff_denom_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ETA_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ETA_","elec #eta, barrel+endcap, ecal+tracker-driven, non-trig-matched;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, non-trig-matched, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, non-trig-matched, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, non-trig-matched, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, non-trig-matched, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__L1_EG5_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
  eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ETA__L1_EG8_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
...
//   // barrel, ecal, match, vs elec SC ET
//   eff_denom_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, barrel, ECAL-driven, trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, barrel, ECAL-driven, trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel, ECAL-driven, trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel, ECAL-driven, trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel, ECAL-driven, trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel, ECAL-driven, trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // barrel, ecal, match, vs eta
//   eff_denom_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__L1_EG5_","elec #eta, barrel, ECAL-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__L1_EG8_","elec #eta, barrel, ECAL-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel, ECAL-driven, trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel, ECAL-driven, trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel, ECAL-driven, trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel, ECAL-driven, trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // barrel, ecal, non-match, vs elec SC ET
//   eff_denom_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, barrel, ECAL-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, barrel, ECAL-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel, ECAL-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel, ECAL-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel, ECAL-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel, ECAL-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // barrel, ecal, non-match, vs eta
//   eff_denom_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_","elec #eta, barrel, ECAL-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_","elec #eta, barrel, ECAL-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel, ECAL-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel, ECAL-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel, ECAL-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel, ECAL-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // barrel, tracker, match, vs elec SC ET
//   eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, barrel, tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, barrel, tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // barrel, tracker, match, vs eta
//   eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__L1_EG5_","elec #eta, barrel, tracker-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__L1_EG8_","elec #eta, barrel, tracker-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel, tracker-driven, trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel, tracker-driven, trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel, tracker-driven, trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel, tracker-driven, trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // barrel, tracker, non-match, vs elec SC ET
//   eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, barrel, tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, barrel, tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // barrel, tracker, non-match, vs eta
//   eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_","elec #eta, barrel, tracker-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_","elec #eta, barrel, tracker-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // barrel, ecal+tracker, match, vs elec SC ET
//   eff_denom_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, barrel, ecal+tracker-driven, trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, barrel, ecal+tracker-driven, trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // barrel, ecal+tracker, match, vs eta
//   eff_denom_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__L1_EG5_","elec #eta, barrel, ecal+tracker-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__L1_EG8_","elec #eta, barrel, ecal+tracker-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel, ecal+tracker-driven, trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel, ecal+tracker-driven, trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel, ecal+tracker-driven, trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel, ecal+tracker-driven, trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // barrel, ecal+tracker, non-match, vs elec SC ET
//   eff_denom_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, barrel, ecal+tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, barrel, ecal+tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // barrel, ecal+tracker, non-match, vs eta
//   eff_denom_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_"      ,"elec #eta, barrel, ecal+tracker-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_"      ,"elec #eta, barrel, ecal+tracker-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // endcap, ecal, match, vs elec SC ET
//   eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, endcap, ECAL-driven, trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, endcap, ECAL-driven, trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, endcap, ECAL-driven, trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, endcap, ECAL-driven, trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, endcap, ECAL-driven, trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, endcap, ECAL-driven, trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // endcap, ecal, match, vs eta
//   eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__L1_EG5_","elec #eta, endcap, ECAL-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__L1_EG8_","elec #eta, endcap, ECAL-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, endcap, ECAL-driven, trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, endcap, ECAL-driven, trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, endcap, ECAL-driven, trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, endcap, ECAL-driven, trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // endcap, ecal, non-match, vs elec SC ET
//   eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, endcap, ECAL-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, endcap, ECAL-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // endcap, ecal, non-match, vs eta
//   eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_","elec #eta, endcap, ECAL-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_","elec #eta, endcap, ECAL-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // endcap, tracker, match, vs elec SC ET
//   eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, endcap, tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, endcap, tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // endcap, tracker, match, vs eta
//   eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__L1_EG5_","elec #eta, endcap, tracker-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__L1_EG8_","elec #eta, endcap, tracker-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, endcap, tracker-driven, trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, endcap, tracker-driven, trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, endcap, tracker-driven, trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, endcap, tracker-driven, trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // endcap, tracker, non-match, vs elec SC ET
//   eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, endcap, tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, endcap, tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // endcap, tracker, non-match, vs eta
//   eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_","elec #eta, endcap, tracker-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_","elec #eta, endcap, tracker-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // endcap, ecal+tracker, match, vs elec SC ET
//   eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, endcap, ecal+tracker-driven, trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, endcap, ecal+tracker-driven, trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // endcap, ecal+tracker, match, vs eta
//   eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__L1_EG5_","elec #eta, endcap, ecal+tracker-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__L1_EG8_","elec #eta, endcap, ecal+tracker-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // endcap, ecal+tracker, non-match, vs elec SC ET
//   eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, endcap, ecal+tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, endcap, ecal+tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // endcap, ecal+tracker, non-match, vs eta
//   eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_"      ,"elec #eta, endcap, ecal+tracker-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_"      ,"elec #eta, endcap, ecal+tracker-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_ENDCAP__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // barrel+endcap, ecal, match, vs elec SC ET
//   eff_denom_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, barrel+endcap, ECAL-driven, trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, barrel+endcap, ECAL-driven, trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // barrel+endcap, ecal, match, vs eta
//   eff_denom_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__L1_EG5_","elec #eta, barrel+endcap, ECAL-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__L1_EG8_","elec #eta, barrel+endcap, ECAL-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel+endcap, ECAL-driven, trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel+endcap, ECAL-driven, trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel+endcap, ECAL-driven, trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel+endcap, ECAL-driven, trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // barrel+endcap, ecal, non-match, vs elec SC ET
//   eff_denom_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, barrel+endcap, ECAL-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, barrel+endcap, ECAL-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel+endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // barrel+endcap, ecal, non-match, vs eta
//   eff_denom_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_","elec #eta, barrel+endcap, ECAL-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_","elec #eta, barrel+endcap, ECAL-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel+endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel+endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel+endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_ECAL__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel+endcap, ECAL-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // barrel+endcap, tracker, match, vs elec SC ET
//   eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // barrel+endcap, tracker, match, vs eta
//   eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__L1_EG5_","elec #eta, barrel+endcap, tracker-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__L1_EG8_","elec #eta, barrel+endcap, tracker-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel+endcap, tracker-driven, trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel+endcap, tracker-driven, trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel+endcap, tracker-driven, trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel+endcap, tracker-driven, trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // barrel+endcap, tracker, non-match, vs elec SC ET
//   eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel+endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // barrel+endcap, tracker, non-match, vs eta
//   eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_","elec #eta, barrel+endcap, tracker-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_","elec #eta, barrel+endcap, tracker-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel+endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel+endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel+endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_TRACKER__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel+endcap, tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // barrel+endcap, ecal+tracker, match, vs elec SC ET
//   eff_denom_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, barrel+endcap, ecal+tracker-driven, trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, barrel+endcap, ecal+tracker-driven, trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // barrel+endcap, ecal+tracker, match, vs eta
//   eff_denom_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__L1_EG5_","elec #eta, barrel+endcap, ecal+tracker-driven, trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__L1_EG8_","elec #eta, barrel+endcap, ecal+tracker-driven, trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_MATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);

//   // barrel+endcap, ecal+tracker, non-match, vs elec SC ET
//   eff_denom_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG5_","elec SC E_{T}, barrel+endcap, ecal+tracker-driven, non-trig-matched, L1_EG5;Electron SC E_{T};",60,0.,60.);
//   eff_denom_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__L1_EG8_","elec SC E_{T}, barrel+endcap, ecal+tracker-driven, non-trig-matched, L1_EG8;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC10_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_ELEC15_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT10_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron SC E_{T};",60,0.,60.);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ELEC_SC_ET__HLT_PHOT15_","Eff vs elec SC E_{T}, barrel+endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron SC E_{T};",60,0.,60.);

//   // barrel+endcap, ecal+tracker, non-match, vs eta
//   eff_denom_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__L1_EG5_","elec #eta, barrel+endcap, ecal+tracker-driven, non-trig-matched, L1_EG5;Electron #eta;",64,-3.2,3.2);
//   eff_denom_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_ = fs->make<TH1F>("eff_denom_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__L1_EG8_","elec #eta, barrel+endcap, ecal+tracker-driven, non-trig-matched, L1_EG8;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC10_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_ELEC15_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_ELEC15;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT10_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT10;Electron #eta;",64,-3.2,3.2);
//   eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_ = fs->make<TH1F>("eff_num_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED_REL__VS_ETA__HLT_PHOT15_","Eff vs elec #eta, barrel+endcap, ecal+tracker-driven, non-trig-matched, rel. to L1, HLT_PHOT15;Electron #eta;",64,-3.2,3.2);
  ...
  // supercluster Et
  chtitle = collName+"Supercluster: Et, barrel+endcap;E (GeV);";
  h_sc_et_ = fs->make<TH1F>("SC_ET",chtitle.data(),100,0.,100.);
...
//   h_sc_preshowerEnergy_ = fs->make<TH1F>("SC_PRESHOWERENERGY",chtitle.data(),100,0.,50.);
  ...
  // supercluster Et
  chtitle = collName+"Supercluster: Et, barrel-only;E (GeV);";
  h_sc_etBarrel_ = fs->make<TH1F>("SC_ETBARREL",chtitle.data(),100,0.,100.);
...
//   h_sc_preshowerEnergyBarrel_ = fs->make<TH1F>("SC_PRESHOWERENERGYBARREL",chtitle.data(),100,0.,50.);
  ...
  // supercluster Et
  chtitle = collName+"Supercluster: Et, endcap-only;E (GeV);";
  h_sc_etEndcap_ = fs->make<TH1F>("SC_ETENDCAP",chtitle.data(),100,0.,100.);
...
// 	}
      ...
      // Track collection
      if (!ev.getByLabel("generalTracks", trackCollection)) {
	LogWarning("") << ">>> Track collection does not exist !!!";
	return;
      }
      //      ele_nelectrons_ = electronCollection->size();

      // DCS info for magnetic field
      // all this came straight off twiki page
      // https://twiki.cern.ch/twiki/bin/view/CMS/ConversionBackgroundRejection on June 7, 2010
      // 
      edm::Handle<DcsStatusCollection> dcsHandle;
      //      iEvent.getByLabel(dcsTag_, dcsHandle); /////////////////////////// FIND DCS TAG
      ev.getByLabel("scalersRawToDigi", dcsHandle); // from searching lxr for DcsStatusCollection
      double evt_bField;
...
//       nz2_before_->Fill(nmuonsForZ2);
	...
	{ 
      ...
      edm::Handle< l1extra::L1EmParticleCollection > isoEmColl ;
      //      iEvent.getByLabel( isoEmSource_, isoEmColl ) ;
      ev.getByLabel( edm::InputTag("l1extraParticles","Isolated"), isoEmColl ) ;
      //      std::cout << "Number of isolated EM " << isoEmColl->size() << std::endl ;
      l1_nL1Obj_ = 8;
      //int l1_nL1Obj_isol_ = isoEmColl->size();
...
// 			<< " phi " << emItr->phi()
// 			<< std::endl ;
	      l1_et_[l1count] = emItr->et();
	      l1_eta_[l1count] = emItr->eta();
	      l1_phi_[l1count] = emItr->phi();
	      l1count++;
	    }
	  else
	    {
	      //	      std::cout << "More than 8 L1 particles!" << std::endl;
	    }
	}

      // Non-isolated EM particles
      edm::Handle< l1extra::L1EmParticleCollection > nonIsoEmColl ;
      //      iEvent.getByLabel( nonIsoEmSource_, nonIsoEmColl ) ;
      ev.getByLabel( edm::InputTag("l1extraParticles","NonIsolated"), nonIsoEmColl ) ;
      //      int l1_nL1Obj_nonisol_ = nonIsoEmColl->size();
...
// 			<< std::endl ;
      ...
      //      l1_nL1Obj_ = l1_nL1Obj_isol_ + l1_nL1Obj_nonisol_;


      // HLT

      edm::Handle<trigger::TriggerEvent> trgEvent;
      ev.getByLabel(InputTag("hltTriggerSummaryAOD","","HLT"), trgEvent);
      ...
      // HLT_Ele15_LW_L1R hltL1NonIsoHLTNonIsoSingleElectronLWEt15PixelMatchFilter
      // HLT_Photon10_L1R hltL1NonIsoHLTNonIsoSinglePhotonEt10HcalIsolFilter
      // HLT_Photon15_L1R hltL1NonIsoHLTNonIsoSinglePhotonEt15HcalIsolFilter
      //      hlt_nHltTrig_ = 4;
      edm::InputTag filter_HLT[k_HLTTRIG];
      filter_HLT[0] = edm::InputTag("hltL1NonIsoHLTNonIsoSingleElectronLWEt10PixelMatchFilter","","HLT");
      filter_HLT[1] = edm::InputTag("hltL1NonIsoHLTNonIsoSingleElectronLWEt15PixelMatchFilter","","HLT");
      filter_HLT[2] = edm::InputTag("hltL1NonIsoHLTNonIsoSinglePhotonEt10HcalIsolFilter","","HLT");
      filter_HLT[3] = edm::InputTag("hltL1NonIsoHLTNonIsoSinglePhotonEt15HcalIsolFilter","","HLT");
      const trigger::TriggerObjectCollection& TOC(trgEvent->getObjects());

//       for (int nFilter = 0; nFilter < k_HLTTRIG; nFilter++)
// 	{
// 	  // filterIndex must be less than the size of trgEvent or you get a CMSException: _M_range_check
// 	  //if ( trgEvent->filterIndex(filter_HLT[nFilter]) < trgEvent->size() )
// 	  if ( trgEvent->filterIndex(filter_HLT[nFilter]) < trgEvent->sizeFilters() ) 
// 	    {
// 	      const trigger::Keys& keys( trgEvent->filterKeys( trgEvent->filterIndex(filter_HLT[nFilter]) ) );
...
// 		  if (hlto < k_HLTOBJ_MAX)
// 		    {
// 		      hlt_et_[nFilter][hlto] = L3obj.et();
// 		      hlt_eta_[nFilter][hlto] = L3obj.eta();
// 		      hlt_phi_[nFilter][hlto] = L3obj.phi();
// 		    }
// 		}
// 	    }
// 	}

      hlt_nHltObj_Elec10_ = 0;
      hlt_nHltObj_Elec15_ = 0;
      hlt_nHltObj_Phot10_ = 0;
      hlt_nHltObj_Phot15_ = 0;

      // ELEC 10
      // filterIndex must be less than the size of trgEvent or you get a CMSException: _M_range_check
      if ( trgEvent->filterIndex(filter_HLT[0]) < trgEvent->sizeFilters() ) 
	{
	  const trigger::Keys& keys( trgEvent->filterKeys( trgEvent->filterIndex(filter_HLT[0]) ) );

	  if (keys.size() < k_HLTOBJ_MAX)
	    {
	      hlt_nHltObj_Elec10_ = keys.size();
	    }
	  else
	    {
	      hlt_nHltObj_Elec10_ = k_HLTOBJ_MAX;
	    }
	  //	  std::cout << "hlt_nHltObj_Elec10_ is " << hlt_nHltObj_Elec10_ << std::endl;
	  for ( unsigned int hlto = 0; hlto < keys.size(); hlto++ ) 
	    {
	      trigger::size_type hltf = keys[hlto];
	      const trigger::TriggerObject& L3obj(TOC[hltf]);
	      ...
	      if (hlto < k_HLTOBJ_MAX)
		{
		  hlt_Elec10_et_[hlto] = L3obj.et();
		  hlt_Elec10_eta_[hlto] = L3obj.eta();
		  hlt_Elec10_phi_[hlto] = L3obj.phi();
// 		  std::cout << "Electron # " << hlto 
// 			    << " et is " << hlt_Elec10_et_[hlto] 
// 			    << " eta is " << hlt_Elec10_eta_[hlto] 
// 			    << " phi is " << hlt_Elec10_phi_[hlto] 
// 			    << std::endl;
		}
	    }
	}
      ...
      // ELEC 15
      // filterIndex must be less than the size of trgEvent or you get a CMSException: _M_range_check
      if ( trgEvent->filterIndex(filter_HLT[1]) < trgEvent->sizeFilters() ) 
	{
	  const trigger::Keys& keys( trgEvent->filterKeys( trgEvent->filterIndex(filter_HLT[1]) ) );

	  if (keys.size() < k_HLTOBJ_MAX)
	    {
	      hlt_nHltObj_Elec15_ = keys.size();
	    }
	  else
	    {
	      hlt_nHltObj_Elec15_ = k_HLTOBJ_MAX;
	    }
	  for ( unsigned int hlto = 0; hlto < keys.size(); hlto++ ) 
	    {
	      trigger::size_type hltf = keys[hlto];
	      ...
	      if (hlto < k_HLTOBJ_MAX)
		{
		  hlt_Elec15_et_[hlto] = L3obj.et();
		  hlt_Elec15_eta_[hlto] = L3obj.eta();
		  hlt_Elec15_phi_[hlto] = L3obj.phi();
		}
	    }
	}
      ...
      // PHOT 10
      // filterIndex must be less than the size of trgEvent or you get a CMSException: _M_range_check
      if ( trgEvent->filterIndex(filter_HLT[2]) < trgEvent->sizeFilters() ) 
	{
	  const trigger::Keys& keys( trgEvent->filterKeys( trgEvent->filterIndex(filter_HLT[2]) ) );

	  if (keys.size() < k_HLTOBJ_MAX)
	    {
	      hlt_nHltObj_Phot10_ = keys.size();
	    }
	  else
	    {
	      hlt_nHltObj_Phot10_ = k_HLTOBJ_MAX;
	    }
	  for ( unsigned int hlto = 0; hlto < keys.size(); hlto++ ) 
	    {
	      trigger::size_type hltf = keys[hlto];
	      ...
	      if (hlto < k_HLTOBJ_MAX)
		{
		  hlt_Phot10_et_[hlto] = L3obj.et();
		  hlt_Phot10_eta_[hlto] = L3obj.eta();
		  hlt_Phot10_phi_[hlto] = L3obj.phi();
		}
	    }
	}
      ...
      // PHOT 15
      // filterIndex must be less than the size of trgEvent or you get a CMSException: _M_range_check
      if ( trgEvent->filterIndex(filter_HLT[3]) < trgEvent->sizeFilters() ) 
	{
	  const trigger::Keys& keys( trgEvent->filterKeys( trgEvent->filterIndex(filter_HLT[3]) ) );
	  
	  if (keys.size() < k_HLTOBJ_MAX)
	    {
	      hlt_nHltObj_Phot15_ = keys.size();
	    }
	  else
	    {
	      hlt_nHltObj_Phot15_ = k_HLTOBJ_MAX;
	    }
	  for ( unsigned int hlto = 0; hlto < keys.size(); hlto++ ) 
	    {
	      trigger::size_type hltf = keys[hlto];
	      ...
	      if (hlto < k_HLTOBJ_MAX)
		{
		  hlt_Phot15_et_[hlto] = L3obj.et();
		  hlt_Phot15_eta_[hlto] = L3obj.eta();
		  hlt_Phot15_phi_[hlto] = L3obj.phi();
		}
	    }
	}
...
//       bool nz2_hist_done = false;
      ...
      for (unsigned int i = 0; i < 2; i++)
	{
      ...
      double highestScEtElectronEt = 0.;
      double highestScEtElectronScEt = 0.;
      double highestScEtElectronEta = -999.;
      double highestScEtElectronPhi = -999.;
      double highestScEtElectronPt = -999.;

      double highestScEtElectronSieie = 999.;
      double highestScEtElectronDetain = 999.;
      double highestScEtElectronDphiin = 999.;
      double highestScEtElectronHoE = 999.;

      int highestScEtElectronNHitsMiss = -9999;
      double highestScEtElectronDist = 999.;
      double highestScEtElectronDcotTheta = 999.;

      double highestScEtElectronIsoVar = -999.;
      double highestScEtElectronEcalIso = -999.;
      double highestScEtElectronHcalIso = -999.;
      double highestScEtElectronTrackIso = -999.;

      bool highestScEtElectronIsBarrel = false;
      bool highestScEtElectronIsEndcap = false;

      bool highestScEtElectronIsEcalDriven = false;
      bool highestScEtElectronIsTrackerDriven = false;

      bool highestScEtElectronIsGood = false;
      //      double highestGoodElectronPt = 0.;
      hasWCand_ = false;
      hasZCand_ = false;


      //      std::cout << "START ELECTRON FILLING" << std::endl;
      ...
      for (int i = 0; i < ele_nelectrons_; i++) 
	{
	  ...
	  float spikeTemp = eeMax/ee3x3;
	  if (spikeTemp > 0.95)
	    continue;
	  ele_rmax3x3_[i] = spikeTemp;
	  ...
	  const reco::Track *el_track = (const reco::Track*)(elec.gsfTrack().get());  
	  const reco::HitPattern& p_inner = el_track->trackerExpectedHitsInner(); 
	  //	  int NumberOfExpectedInnerHits = p_inner.numberOfHits();
	  ele_nexpectedinnerhits_[i] = p_inner.numberOfHits();
	  ConversionFinder convFinder;
	  ConversionInfo convInfo = convFinder.getConversionInfo(elec, trackCollection, evt_bField);
	  ele_dist_[i] = convInfo.dist();
	  ele_dcottheta_[i] = convInfo.dcot();
	  ...
	  if (hasPtGt10)
	    {
	      ...
	      h_ele_nExpectedInnerHits_before_->Fill(ele_nexpectedinnerhits_[i]);
	      h_ele_dcotTheta_before_->Fill(ele_dcottheta_[i]);
	      h_ele_dist_before_->Fill(ele_dist_[i]);
	    }
	  ...
	  ele_scet_[i] = (supercluster->energy()/std::cosh(supercluster->eta())) ; // NOT ACTUALLY CANDIDATE METHOD
	  ...
	  if (hasPtGt10)
	    {
	      ...
	      h_ele_scet_before_->Fill(ele_scet_[i]) ; // NOT ACTUALLY CANDIDATE METHOD
...
// 	  double ele_trkisovar_[i] = elec.dr04TkSumPt();           // doesn't work 
	  ...
	  if (ele_scet_[i] > highestScEtElectronScEt)
	    {
	      highestScEtElectronEt = ele_et_[i];
	      highestScEtElectronScEt = ele_scet_[i];
	      highestScEtElectronEta = ele_eta_[i];
	      highestScEtElectronPhi = ele_phi_[i];
	      highestScEtElectronPt = ele_pt_[i];

	      highestScEtElectronSieie = ele_sigmaietaieta_[i];
	      highestScEtElectronDetain = ele_deltaetasuperclustertrackatvtx_[i];
	      highestScEtElectronDphiin = ele_deltaphisuperclustertrackatvtx_[i];
	      highestScEtElectronHoE = ele_hcaloverecal_[i];

	      highestScEtElectronNHitsMiss = ele_nexpectedinnerhits_[i];
	      highestScEtElectronDist = ele_dist_[i];
	      highestScEtElectronDcotTheta = ele_dcottheta_[i];

	      highestScEtElectronIsBarrel = ele_isBarrel_[i];
	      highestScEtElectronIsEndcap = ele_isEndcap_[i];

	      highestScEtElectronIsEcalDriven = ele_isEcalDriven_[i];
	      highestScEtElectronIsTrackerDriven = ele_isTrackerDriven_[i];

	      highestScEtElectronEcalIso = ele_dr03ecalrechitsumet_[i];
	      highestScEtElectronHcalIso = ele_dr03hcaltowersumet_[i];
	      highestScEtElectronTrackIso = ele_dr03tksumpt_[i];

	      if (highestScEtElectronIsBarrel)
		{
		  highestScEtElectronIsoVar = (highestScEtElectronTrackIso + max(0., (double) highestScEtElectronEcalIso - 1) + highestScEtElectronHcalIso) / highestScEtElectronPt;
		}
	      else if (highestScEtElectronIsEndcap)
		{
		  highestScEtElectronIsoVar = (highestScEtElectronTrackIso + highestScEtElectronEcalIso + highestScEtElectronHcalIso) / highestScEtElectronPt;
		}
	  ...
	  if (flags_passed >= (NFLAGS-1)) 
		...
		{
		  highestScEtElectronIsGood = true;
		  ...
		  h_ele_nExpectedInnerHits_after_->Fill(ele_nexpectedinnerhits_[i]);
		  h_ele_dcotTheta_after_->Fill(ele_dcottheta_[i]);
		  h_ele_dist_after_->Fill(ele_dist_[i]);
		  ...
		  h_ele_scet_after_->Fill(ele_scet_[i]) ; // NOT ACTUALLY CANDIDATE METHOD
      ...
      //      std::cout << "END ELECTRON FILLING" << std::endl;

      LogTrace("") << "Numbers of good electrons is " << goodElecs->size() << std::endl;


      //      std::cout << "START ELECTRON EFFS" << std::endl;


      result_HLTElec10_ = false;
      result_HLTElec15_ = false;
      result_HLTPhot10_ = false;
      result_HLTPhot15_ = false;
      result_L1EG5_ = false;
      result_L1EG8_ = false;
      
      // efficiencies! with some loose electron ID requirements
      if (highestScEtElectronDetain < 0.1 && highestScEtElectronDetain > -0.1 && highestScEtElectronHoE < 0.05)
	{
	  // fill trigger efficiency denominator histogram
	  h_trg_Denominator_eff_->Fill(highestScEtElectronEt);
	  h_trg_Denominator_eff_eta_->Fill(highestScEtElectronEta);
	  h_trg_Denominator_eff_etaPt_->Fill(highestScEtElectronEta,highestScEtElectronEt,1.);
	  
	  // fill special denoms
	  if (highestScEtElectronEt > 5.)
	    {
	      h_trg_Denominator_eff_eta_cutPt5_->Fill(highestScEtElectronEta);
	    }
	  if (highestScEtElectronIsEcalDriven)
	    {
	      h_trg_Denominator_eff_ecalDriven_->Fill(highestScEtElectronEt);
	    }
	  if (highestScEtElectronIsBarrel)
	    {
	      h_trg_Denominator_eff_barrel_->Fill(highestScEtElectronEt);
	    }
	  if (highestScEtElectronIsGood)
	    {
	      h_trg_Denominator_eff_goodEle_->Fill(highestScEtElectronEt);
	    }

	  // fill trigger efficiency numerator histograms
	  //       if (highestScEtElectronEt > 30.)
	  // 	{
	  if (triggersOfInterest_->find("HLT_Photon30_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon30_L1R")->second == true) 
	    {
	      h_trg_HLT_Photon30_L1R_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("HLT_Photon30_L1R",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_HLT_Photon30_L1R_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  // 	}
	  //       if (highestScEtElectronEt > 20.)
	  // 	{
	  if (triggersOfInterest_->find("HLT_Ele20_LW_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Ele20_LW_L1R")->second == true) 
	    {
	      h_trg_HLT_Ele20_LW_L1R_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("HLT_Ele20_LW_L1R",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_HLT_Ele20_LW_L1R_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  if (triggersOfInterest_->find("HLT_Photon20_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon20_L1R")->second == true) 
	    {
	      h_trg_HLT_Photon20_L1R_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("HLT_Photon20_L1R",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_HLT_Photon20_L1R_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleEG20") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG20")->second == true) 
	    {
	      h_trg_L1_SingleEG20_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("L1_SingleEG20",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_L1_SingleEG20_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  // 	}
	  //       if (highestScEtElectronEt > 15.)
	  // 	{
	  if (triggersOfInterest_->find("HLT_Ele15_LW_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Ele15_LW_L1R")->second == true) 
	    {
	      ...
	      h_trg_HLT_Ele15_LW_L1R_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("HLT_Ele15_LW_L1R",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_HLT_Ele15_LW_L1R_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  if (triggersOfInterest_->find("HLT_Ele15_SiStrip_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Ele15_SiStrip_L1R")->second == true) 
	    {
	      h_trg_HLT_Ele15_SiStrip_L1R_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("HLT_Ele15_SiStrip_L1R",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_HLT_Ele15_SiStrip_L1R_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  if (triggersOfInterest_->find("HLT_Photon15_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon15_L1R")->second == true) 
	    {
	      ...
	      h_trg_HLT_Photon15_L1R_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("HLT_Photon15_L1R",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_HLT_Photon15_L1R_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  if (triggersOfInterest_->find("HLT_Photon15_TrackIso_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon15_TrackIso_L1R")->second == true) 
	    {
	      h_trg_HLT_Photon15_TrackIso_L1R_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("HLT_Photon15_TrackIso_L1R",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_HLT_Photon15_TrackIso_L1R_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	  ...
	  if (triggersOfInterest_->find("HLT_Photon15_LooseEcalIso_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon15_LooseEcalIso_L1R")->second == true) 
	    {
	      h_trg_HLT_Photon15_LooseEcalIso_L1R_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("HLT_Photon15_LooseEcalIso_L1R",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_HLT_Photon15_LooseEcalIso_L1R_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  ...
	  if (l1TriggersOfInterest_->find("L1_SingleIsoEG15") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleIsoEG15")->second == true) 
	    {
	      h_trg_L1_SingleIsoEG15_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("L1_SingleIsoEG15",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_L1_SingleIsoEG15_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleEG15") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG15")->second == true) 
	    {
	      h_trg_L1_SingleEG15_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("L1_SingleEG15",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_L1_SingleEG15_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  // 	}
	  //       if (highestScEtElectronEt > 12.)
	  // 	{
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleIsoEG12") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleIsoEG12")->second == true) 
	    {
	      h_trg_L1_SingleIsoEG12_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("L1_SingleIsoEG12",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_L1_SingleIsoEG12_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleEG12") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG12")->second == true) 
	    {
	      h_trg_L1_SingleEG12_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("L1_SingleEG12",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_L1_SingleEG12_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  // 	}
	  //       if (highestScEtElectronEt > 10.)
	  // 	{
	  if (triggersOfInterest_->find("HLT_Ele10_LW_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Ele10_LW_L1R")->second == true) 
	    {
	      ...
	      h_trg_HLT_Ele10_LW_L1R_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("HLT_Ele10_LW_L1R",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_HLT_Ele10_LW_L1R_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  if (triggersOfInterest_->find("HLT_Ele10_LW_EleId_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Ele10_LW_EleId_L1R")->second == true) 
	    {
	      h_trg_HLT_Ele10_LW_EleId_L1R_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("HLT_Ele10_LW_EleId_L1R",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_HLT_Ele10_LW_EleId_L1R_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	  ...
	  if (triggersOfInterest_->find("HLT_Photon10_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon10_L1R")->second == true) 
	    {
	      ...
	      h_trg_HLT_Photon10_L1R_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("HLT_Photon10_L1R",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_HLT_Photon10_L1R_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleIsoEG10") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleIsoEG10")->second == true) 
	    {
	      h_trg_L1_SingleIsoEG10_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("L1_SingleIsoEG10",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_L1_SingleIsoEG10_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleEG10") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG10")->second == true) 
	    {
	      h_trg_L1_SingleEG10_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("L1_SingleEG10",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_L1_SingleEG10_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  // 	}
	  //       if (highestScEtElectronEt > 8.)
	  // 	{
	  if (triggersOfInterest_->find("HLT_L1SingleEG8") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_L1SingleEG8")->second == true) 
	    {
	      h_trg_HLT_L1SingleEG8_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("HLT_L1SingleEG8",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_HLT_L1SingleEG8_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleIsoEG8") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleIsoEG8")->second == true) 
	    {
	      h_trg_L1_SingleIsoEG8_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("L1_SingleIsoEG8",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_L1_SingleIsoEG8_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleEG8") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG8")->second == true) 
	    {
	      result_L1EG8_ = true;
	      h_trg_L1_SingleEG8_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("L1_SingleEG8",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_L1_SingleEG8_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  // 	}
	  //       if (highestScEtElectronEt > 5.)
	  ...
	  if (triggersOfInterest_->find("HLT_L1SingleEG5") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_L1SingleEG5")->second == true) 
	    {
	      result_L1EG5_ = true;
	      h_trg_HLT_L1SingleEG5_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("HLT_L1SingleEG5",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_HLT_L1SingleEG5_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleIsoEG5") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleIsoEG5")->second == true) 
	    {
	      h_trg_L1_SingleIsoEG5_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("L1_SingleIsoEG5",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_L1_SingleIsoEG5_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleEG5") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG5")->second == true) 
	    {
	      h_trg_L1_SingleEG5_eff_->Fill(highestScEtElectronEt);
	      h_trg_L1_SingleEG5_eff_eta_->Fill(highestScEtElectronEta);
	      h_trg_L1_SingleEG5_eff_etaPt_->Fill(highestScEtElectronEta,highestScEtElectronEt,1.);
	      h_trg_highestEtVsThreshold_->Fill("L1_SingleEG5",highestScEtElectronEt,1.);
	      if (highestScEtElectronEt > 5.)
		{
		  h_trg_L1_SingleEG5_eff_eta_cutPt5_->Fill(highestScEtElectronEta);
		}
	      if (highestScEtElectronIsBarrel)
		{
		  h_trg_L1_SingleEG5_eff_barrel_->Fill(highestScEtElectronEt);
		}
	      if (highestScEtElectronIsEcalDriven)
		{
		  h_trg_L1_SingleEG5_eff_ecalDriven_->Fill(highestScEtElectronEt);
		}
	      if (highestScEtElectronIsGood)
		{
		  h_trg_L1_SingleEG5_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  else if (l1TriggersOfInterest_->find("L1_SingleEG5") != l1TriggersOfInterest_->end())
	    {
	      h_trg_L1_SingleEG5_eff_notfire1_->Fill(highestScEtElectronEt);
	      h_trg_L1_SingleEG5_eff_eta_notfire1_->Fill(highestScEtElectronEta);
	    }
	  else
	    {
	      h_trg_L1_SingleEG5_eff_notfire2_->Fill(highestScEtElectronEt);
	      h_trg_L1_SingleEG5_eff_eta_notfire2_->Fill(highestScEtElectronEta);
	    }
	  // 	}
	  //       if (highestScEtElectronEt > 2.)
	  // 	{
	  // L1! 2!
	  if (l1TriggersOfInterest_->find("L1_SingleEG2") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG2")->second == true) 
	    {
	      h_trg_L1_SingleEG2_eff_->Fill(highestScEtElectronEt);
	      h_trg_highestEtVsThreshold_->Fill("L1_SingleEG2",highestScEtElectronEt,1.);
	      if (highestScEtElectronIsGood)
		{
		  h_trg_L1_SingleEG2_eff_goodEle_->Fill(highestScEtElectronEt);
		}
	    }
	  //	}
	}      
      ...
      // efficiencies wrt electron supercluster Et
      if (highestScEtElectronDetain < 0.1 && highestScEtElectronDetain > -0.1 && highestScEtElectronHoE < 0.05)
	{
	  // fill trigger efficiency denominator histogram
	  h_trg_Denominator_eff_eleSC_->Fill(highestScEtElectronScEt);

	  // fill trigger efficiency numerator histograms
	  if (triggersOfInterest_->find("HLT_Photon30_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon30_L1R")->second == true) 
	    {
	      h_trg_HLT_Photon30_L1R_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  if (triggersOfInterest_->find("HLT_Ele20_LW_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Ele20_LW_L1R")->second == true) 
	    {
	      h_trg_HLT_Ele20_LW_L1R_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  if (triggersOfInterest_->find("HLT_Photon20_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon20_L1R")->second == true) 
	    {
	      h_trg_HLT_Photon20_L1R_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleEG20") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG20")->second == true) 
	    {
	      h_trg_L1_SingleEG20_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  if (triggersOfInterest_->find("HLT_Ele15_LW_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Ele15_LW_L1R")->second == true) 
	    {
	      h_trg_HLT_Ele15_LW_L1R_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  if (triggersOfInterest_->find("HLT_Ele15_SiStrip_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Ele15_SiStrip_L1R")->second == true) 
	    {
	      h_trg_HLT_Ele15_SiStrip_L1R_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  if (triggersOfInterest_->find("HLT_Photon15_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon15_L1R")->second == true) 
	    {
	      h_trg_HLT_Photon15_L1R_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  if (triggersOfInterest_->find("HLT_Photon15_TrackIso_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon15_TrackIso_L1R")->second == true) 
	    {
	      h_trg_HLT_Photon15_TrackIso_L1R_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  if (triggersOfInterest_->find("HLT_Photon15_LooseEcalIso_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon15_LooseEcalIso_L1R")->second == true) 
	    {
	      h_trg_HLT_Photon15_LooseEcalIso_L1R_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
      
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleIsoEG15") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleIsoEG15")->second == true) 
	    {
	      h_trg_L1_SingleIsoEG15_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleEG15") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG15")->second == true) 
	    {
	      h_trg_L1_SingleEG15_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleIsoEG12") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleIsoEG12")->second == true) 
	    {
	      h_trg_L1_SingleIsoEG12_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleEG12") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG12")->second == true) 
	    {
	      h_trg_L1_SingleEG12_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  if (triggersOfInterest_->find("HLT_Ele10_LW_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Ele10_LW_L1R")->second == true) 
	    {
	      h_trg_HLT_Ele10_LW_L1R_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  if (triggersOfInterest_->find("HLT_Ele10_LW_EleId_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Ele10_LW_EleId_L1R")->second == true) 
	    {
	      h_trg_HLT_Ele10_LW_EleId_L1R_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  if (triggersOfInterest_->find("HLT_Photon10_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon10_L1R")->second == true) 
	    {
	      h_trg_HLT_Photon10_L1R_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleIsoEG10") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleIsoEG10")->second == true) 
	    {
	      h_trg_L1_SingleIsoEG10_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleEG10") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG10")->second == true) 
	    {
	      h_trg_L1_SingleEG10_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  if (triggersOfInterest_->find("HLT_L1SingleEG8") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_L1SingleEG8")->second == true) 
	    {
	      h_trg_HLT_L1SingleEG8_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleIsoEG8") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleIsoEG8")->second == true) 
	    {
	      h_trg_L1_SingleIsoEG8_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleEG8") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG8")->second == true) 
	    {
	      h_trg_L1_SingleEG8_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  if (triggersOfInterest_->find("HLT_L1SingleEG5") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_L1SingleEG5")->second == true) 
	    {
	      h_trg_HLT_L1SingleEG5_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleIsoEG5") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleIsoEG5")->second == true) 
	    {
	      h_trg_L1_SingleIsoEG5_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  // L1!
	  if (l1TriggersOfInterest_->find("L1_SingleEG5") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG5")->second == true) 
	    {
	      h_trg_L1_SingleEG5_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
	  // L1! 2!
	  if (l1TriggersOfInterest_->find("L1_SingleEG2") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG2")->second == true) 
	    {
	      h_trg_L1_SingleEG2_eff_eleSC_->Fill(highestScEtElectronScEt);
	    }
      ...
      if (highestScEtElectronScEt > 0.)
	{
	  if (highestScEtElectronIsBarrel)
	    {
	      if (result_WP_)
		{
		  nEvents_spike_Barrel_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if (highestScEtElectronIsoVar > isolVarBarrel[wpIndex_]) result_WP_ = false;
	      if (result_WP_)
		{
		  nEvents_combIso_Barrel_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if (highestScEtElectronNHitsMiss > nHitsMiss[wpIndex_]) result_WP_ = false;
	      if (result_WP_)
		{
		  nEvents_missHits_Barrel_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if ( fabs(highestScEtElectronDist) < dist[wpIndex_]) result_WP_ = false;
	      if (result_WP_)
		{
		  nEvents_dist_Barrel_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if ( fabs(highestScEtElectronDcotTheta) < dcotTheta[wpIndex_]) result_WP_ = false;	  
	      if (result_WP_)
		{
		  nEvents_dCotTheta_Barrel_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if (highestScEtElectronSieie > sieieBarrel[wpIndex_]) result_WP_ = false;
	      if (result_WP_)
		{
		  nEvents_sieie_Barrel_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if ( fabs(highestScEtElectronDphiin) > dphiinBarrel[wpIndex_]) result_WP_ = false;
	      if (result_WP_)
		{
		  nEvents_dphiin_Barrel_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if ( fabs(highestScEtElectronDetain) > detainBarrel[wpIndex_]) result_WP_ = false;
	      if (result_WP_)
		{
		  nEvents_detain_Barrel_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if (highestScEtElectronHoE > hoeBarrel[wpIndex_]) result_WP_ = false;
	      if (result_WP_)
		{
		  nEvents_hoe_Barrel_ScEt_->Fill(highestScEtElectronScEt);
		}
	    }
	  else if (highestScEtElectronIsEndcap)
	    {
	      if (result_WP_)
		{
		  nEvents_spike_Endcap_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if (highestScEtElectronIsoVar > isolVarEndcap[wpIndex_]) result_WP_ = false;
	      if (result_WP_)
		{
		  nEvents_combIso_Endcap_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if (highestScEtElectronNHitsMiss > nHitsMiss[wpIndex_]) result_WP_ = false;
	      if (result_WP_)
		{
		  nEvents_missHits_Endcap_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if ( fabs(highestScEtElectronDist) < dist[wpIndex_]) result_WP_ = false;
	      if (result_WP_)
		{
		  nEvents_dist_Endcap_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if ( fabs(highestScEtElectronDcotTheta) < dcotTheta[wpIndex_]) result_WP_ = false;	  
	      if (result_WP_)
		{
		  nEvents_dCotTheta_Endcap_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if (highestScEtElectronSieie > sieieEndcap[wpIndex_]) result_WP_ = false;
	      if (result_WP_)
		{
		  nEvents_sieie_Endcap_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if ( fabs(highestScEtElectronDphiin) > dphiinEndcap[wpIndex_]) result_WP_ = false;
	      if (result_WP_)
		{
		  nEvents_dphiin_Endcap_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if ( fabs(highestScEtElectronDetain) > detainEndcap[wpIndex_]) result_WP_ = false;
	      if (result_WP_)
		{
		  nEvents_detain_Endcap_ScEt_->Fill(highestScEtElectronScEt);
		}
	      if (highestScEtElectronHoE > hoeEndcap[wpIndex_]) result_WP_ = false;
	      if (result_WP_)
		{
		  nEvents_hoe_Endcap_ScEt_->Fill(highestScEtElectronScEt);
		}
	    }
	  else
	    {
      ...
      for (Int_t l1count = 0; l1count < l1_nL1Obj_; l1count++)
	{
	  Float_t deltaEta = highestScEtElectronEta - l1_eta_[l1count];
	  Float_t deltaPhi = highestScEtElectronPhi - l1_phi_[l1count];
      ...
      if (deltaR < 0.5)
	{
      ...
      for (Int_t hltcount = 0; hltcount < hlt_nHltObj_Elec10_; hltcount++)
	{
	  Float_t deltaEta = highestScEtElectronEta - hlt_Elec10_eta_[hltcount];
	  Float_t deltaPhi = highestScEtElectronPhi - hlt_Elec10_phi_[hltcount];
	  while (deltaPhi > 3.1415926535)
	    {
	      deltaPhi = deltaPhi - 2*3.1415926535;
	    }
      ...
      if (deltaR < 0.2)
	{
      ...
      for (Int_t hltcount = 0; hltcount < hlt_nHltObj_Elec15_; hltcount++)
	{
	  Float_t deltaEta = highestScEtElectronEta - hlt_Elec15_eta_[hltcount];
	  Float_t deltaPhi = highestScEtElectronPhi - hlt_Elec15_phi_[hltcount];
	  while (deltaPhi > 3.1415926535)
	    {
	      deltaPhi = deltaPhi - 2*3.1415926535;
	    }
      ...
      if (deltaR < 0.2)
	{
      ...
      for (Int_t hltcount = 0; hltcount < hlt_nHltObj_Phot10_; hltcount++)
	{
	  Float_t deltaEta = highestScEtElectronEta - hlt_Phot10_eta_[hltcount];
	  Float_t deltaPhi = highestScEtElectronPhi - hlt_Phot10_phi_[hltcount];
	  while (deltaPhi > 3.1415926535)
	    {
	      deltaPhi = deltaPhi - 2*3.1415926535;
	    }
      ...
      if (deltaR < 0.2)
	{
      ...
      if (hlt_nHltObj_Phot15_ > 0)
	{
	  //      std::cout << "N Phot 15 objects: " << hlt_nHltObj_Phot15 << std::endl;
	}
      for (Int_t hltcount = 0; hltcount < hlt_nHltObj_Phot15_; hltcount++)
	{
	  Float_t deltaEta = highestScEtElectronEta - hlt_Phot15_eta_[hltcount];
	  Float_t deltaPhi = highestScEtElectronPhi - hlt_Phot15_phi_[hltcount];
	  while (deltaPhi > 3.1415926535)
	    {
	      deltaPhi = deltaPhi - 2*3.1415926535;
	    }
      ...
      if (highestScEtElectronScEt > 0.) // make sure there is one, i.e. it's not -999.
	{
	  if (result_WP_)
	      ...
	      if (highestScEtElectronIsBarrel)
		{
		  ...
		  //if (highestScEtElectronIsTrackerDriven)
		  else if (!highestScEtElectronIsEcalDriven)
		    {
		  ...
		  else if (highestScEtElectronIsEcalDriven && highestScEtElectronIsTrackerDriven)
		    {
                      eff_denom_ETA_BARREL__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET_->Fill(highestScEtElectronScEt);
                      eff_denom_ETA_BOTH__SEED_BOTH__TRIG_UNMATCHED__VS_ELEC_SC_ET_->Fill(highestScEtElectronScEt);
      ...
      if (highestScEtElectronScEt > 0.) // make sure there is one, i.e. it's not -999.
	{
      ...
      // unmatched
      if (highestScEtElectronScEt > 20.) // to make eta plots look reasonable!
	{
	  if (result_WP_)
	    {
	      if (highestScEtElectronIsBarrel)
      ...
      // matched
      if (highestScEtElectronScEt > 20.) // to make sure eta plots look reasonable!
	{
	  if (result_WP_)
	    {
	      if (highestScEtElectronIsBarrel)
      ...
      //      std::cout << "END ELECTRON EFFS" << std::endl;


      //      std::cout << "START Z FILLING" << std::endl;
...
// 	      delete candidate;
      ...
      if (nGoodElecs > 1)
	{
      ...
      //      std::cout << "END Z FILLING" << std::endl;


      // Superclusters

      //      std::cout << "START SC FILLING" << std::endl;
      ...
      double highestSuperClusterEt = 0.;
      double highestEtSuperClusterEta = -999.;
      //      double highestEtSuperClusterDetain = 999.;
      //      double highestEtSuperClusterHoE = 999.;
//       bool highestEtSuperClusterIsBarrel = false;
//       bool highestEtSuperClusterIsEcalDriven = false;
//       bool highestEtSuperClusterIsGood = false;
      //      double highestGoodSuperClusterPt = 0.;
...
//       for (unsigned int i = 0; i < superClustersEBCollection->size(); i++)
 	{
	  ...
	  sc_et_[scCount] = (sc_energy_[scCount]/std::cosh(sc_eta_[scCount]));
	  ...
	  // Quantities for highest-Et SC
	  if (sc_et_[scCount] > highestSuperClusterEt)
	    {
	      highestSuperClusterEt = sc_et_[scCount];
	      //	      std::cout << "new highest-Et supercluster: Et of " << highestSuperClusterEt << std::endl;
	      highestEtSuperClusterEta = sc_eta_[scCount];
// 	      highestEtSuperClusterDetain = sc_deltaetasuperclustertrackatvtx_[scCount];
// 	      highestEtSuperClusterHoE = sc_hcaloverecal_[scCount];
// 	      highestEtSuperClusterIsBarrel = sc_isBarrel_[scCount];
// 	      highestEtSuperClusterIsEcalDriven = sc_isEcalDriven_[scCount];
	    }

	  //	  std::cout << "FILLING GENERAL SC PLOTS (BARREL)" << std::endl;
	  ...
	  //	  std::cout << "FILLING BARREL SC PLOTS (BARREL)" << std::endl;
	  h_sc_energyBarrel_->Fill(sc_energy_[scCount]) ;
	  //	  std::cout << "" << std::endl;
	  h_sc_phiBarrel_->Fill(sc_phi_[scCount]) ;
	  //	  std::cout << "" << std::endl;
	  h_sc_etBarrel_->Fill(sc_et_[scCount]) ;
	  //	  std::cout << "" << std::endl;
...
//       for (unsigned int i = 0; i < superClustersEECollection->size(); i++)
	{
	  //	  std::cout << "LOOPING OVER SC'S" << std::endl;
	  if (scCount >= k_SC_MAX)
	    {
...
// 	      highestEtSuperClusterIsEcalDriven = sc_isEcalDriven_[scCount];
	  ...
	  //	  std::cout << "FILLING GENERAL SC PLOTS (ENDCAP)" << std::endl;
	  h_sc_energy_->Fill(sc_energy_[scCount]) ;
	  h_sc_eta_->Fill(sc_eta_[scCount]) ;
	  h_sc_phi_->Fill(sc_phi_[scCount]) ;
	  h_sc_et_->Fill(sc_et_[scCount]) ;
	  ...
	  //	  std::cout << "FILLING ENDCAP SC PLOTS (ENDCAP)" << std::endl;
	  h_sc_energyEndcap_->Fill(sc_energy_[scCount]) ;
	  h_sc_phiEndcap_->Fill(sc_phi_[scCount]) ;
	  h_sc_etEndcap_->Fill(sc_et_[scCount]) ;
      ...
      //      std::cout << "END SC FILLING" << std::endl;


      // SUPERCLUSTER efficiencies!
      //      std::cout << "START SC EFFS" << std::endl;
      //      if (highestEtSuperClusterDetain < 0.1 && highestEtSuperClusterDetain > -0.1 && highestEtSuperClusterHoE < 0.05)
      //{
      // fill trigger efficiency denominator histogram
      h_trg_Denominator_eff_SC_->Fill(highestSuperClusterEt);

      // fill trigger efficiency numerator histograms
      if (triggersOfInterest_->find("HLT_Photon30_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon30_L1R")->second == true) 
	{
	  h_trg_HLT_Photon30_L1R_eff_SC_->Fill(highestSuperClusterEt);
	}
      if (triggersOfInterest_->find("HLT_Ele20_LW_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Ele20_LW_L1R")->second == true) 
	{
	  h_trg_HLT_Ele20_LW_L1R_eff_SC_->Fill(highestSuperClusterEt);
	}
      if (triggersOfInterest_->find("HLT_Photon20_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon20_L1R")->second == true) 
	{
	  h_trg_HLT_Photon20_L1R_eff_SC_->Fill(highestSuperClusterEt);
	}
      // L1!
      if (l1TriggersOfInterest_->find("L1_SingleEG20") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG20")->second == true) 
	{
	  h_trg_L1_SingleEG20_eff_SC_->Fill(highestSuperClusterEt);
	}
      if (triggersOfInterest_->find("HLT_Ele15_LW_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Ele15_LW_L1R")->second == true) 
	{
	  h_trg_HLT_Ele15_LW_L1R_eff_SC_->Fill(highestSuperClusterEt);
	}
      if (triggersOfInterest_->find("HLT_Ele15_SiStrip_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Ele15_SiStrip_L1R")->second == true) 
	{
	  h_trg_HLT_Ele15_SiStrip_L1R_eff_SC_->Fill(highestSuperClusterEt);
	}
      if (triggersOfInterest_->find("HLT_Photon15_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon15_L1R")->second == true) 
	{
	  h_trg_HLT_Photon15_L1R_eff_SC_->Fill(highestSuperClusterEt);
	}
      if (triggersOfInterest_->find("HLT_Photon15_TrackIso_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon15_TrackIso_L1R")->second == true) 
	{
	  h_trg_HLT_Photon15_TrackIso_L1R_eff_SC_->Fill(highestSuperClusterEt);
	}
      if (triggersOfInterest_->find("HLT_Photon15_LooseEcalIso_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon15_LooseEcalIso_L1R")->second == true) 
	{
	  h_trg_HLT_Photon15_LooseEcalIso_L1R_eff_SC_->Fill(highestSuperClusterEt);
	}
      
      // L1!
      if (l1TriggersOfInterest_->find("L1_SingleIsoEG15") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleIsoEG15")->second == true) 
	{
	  h_trg_L1_SingleIsoEG15_eff_SC_->Fill(highestSuperClusterEt);
	}
      // L1!
      if (l1TriggersOfInterest_->find("L1_SingleEG15") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG15")->second == true) 
	{
	  h_trg_L1_SingleEG15_eff_SC_->Fill(highestSuperClusterEt);
	}
      // L1!
      if (l1TriggersOfInterest_->find("L1_SingleIsoEG12") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleIsoEG12")->second == true) 
	{
	  h_trg_L1_SingleIsoEG12_eff_SC_->Fill(highestSuperClusterEt);
	}
      // L1!
      if (l1TriggersOfInterest_->find("L1_SingleEG12") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG12")->second == true) 
	{
	  h_trg_L1_SingleEG12_eff_SC_->Fill(highestSuperClusterEt);
	}
      if (triggersOfInterest_->find("HLT_Ele10_LW_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Ele10_LW_L1R")->second == true) 
	{
	  h_trg_HLT_Ele10_LW_L1R_eff_SC_->Fill(highestSuperClusterEt);
	}
      if (triggersOfInterest_->find("HLT_Ele10_LW_EleId_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Ele10_LW_EleId_L1R")->second == true) 
	{
	  h_trg_HLT_Ele10_LW_EleId_L1R_eff_SC_->Fill(highestSuperClusterEt);
	}
      if (triggersOfInterest_->find("HLT_Photon10_L1R") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_Photon10_L1R")->second == true) 
	{
	  h_trg_HLT_Photon10_L1R_eff_SC_->Fill(highestSuperClusterEt);
	}
      // L1!
      if (l1TriggersOfInterest_->find("L1_SingleIsoEG10") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleIsoEG10")->second == true) 
	{
	  h_trg_L1_SingleIsoEG10_eff_SC_->Fill(highestSuperClusterEt);
	}
      // L1!
      if (l1TriggersOfInterest_->find("L1_SingleEG10") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG10")->second == true) 
	{
	  h_trg_L1_SingleEG10_eff_SC_->Fill(highestSuperClusterEt);
	}
      if (triggersOfInterest_->find("HLT_L1SingleEG8") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_L1SingleEG8")->second == true) 
	{
	  h_trg_HLT_L1SingleEG8_eff_SC_->Fill(highestSuperClusterEt);
	}
      // L1!
      if (l1TriggersOfInterest_->find("L1_SingleIsoEG8") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleIsoEG8")->second == true) 
	{
	  h_trg_L1_SingleIsoEG8_eff_SC_->Fill(highestSuperClusterEt);
	}
      // L1!
      if (l1TriggersOfInterest_->find("L1_SingleEG8") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG8")->second == true) 
	{
	  h_trg_L1_SingleEG8_eff_SC_->Fill(highestSuperClusterEt);
	}
      if (triggersOfInterest_->find("HLT_L1SingleEG5") != triggersOfInterest_->end() && triggersOfInterest_->find("HLT_L1SingleEG5")->second == true) 
	{
	  h_trg_HLT_L1SingleEG5_eff_SC_->Fill(highestSuperClusterEt);
	}
      // L1!
      if (l1TriggersOfInterest_->find("L1_SingleIsoEG5") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleIsoEG5")->second == true) 
	{
	  h_trg_L1_SingleIsoEG5_eff_SC_->Fill(highestSuperClusterEt);
	}
      // L1!
      if (l1TriggersOfInterest_->find("L1_SingleEG5") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG5")->second == true) 
	{
	  h_trg_L1_SingleEG5_eff_SC_->Fill(highestSuperClusterEt);
	}
      // L1! 2!
      if (l1TriggersOfInterest_->find("L1_SingleEG2") != l1TriggersOfInterest_->end() && l1TriggersOfInterest_->find("L1_SingleEG2")->second == true) 
	{
	  h_trg_L1_SingleEG2_eff_SC_->Fill(highestSuperClusterEt);
	}
      //	}      

      //      std::cout << "END OF SC EFFS" << std::endl;
      ...
      if (makeTree_)
	{
	  ...
	  tree_->Fill();
	  //std::cout << "FINISHED TREE-FILLING FOR THIS EVENT" << std::endl;
	}
