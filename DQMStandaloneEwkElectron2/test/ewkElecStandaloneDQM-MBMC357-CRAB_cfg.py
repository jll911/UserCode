...
#process.ewkElecStandaloneDQM.TrigTag = "TriggerResults::REDIGI" # for Spring10 reprocessed samples!
process.load('EWKTools/HLTPhotonFilter/HLTPhotonFilter_cfi')

process.load("Configuration.StandardSequences.Geometry_cff")
process.load("Configuration.StandardSequences.MagneticField_cff")

process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("ewkElecStandaloneDQM-MC357.root"),
...
#process.GlobalTag.globaltag = cms.string("GR10_P_V4::All") # GR09_R_35X_V4 is for reprocessed data
#process.GlobalTag.globaltag = cms.string("GR10_E_V4::All") # FOR EXPRESS STREAM!!
process.GlobalTag.globaltag = cms.string("START3X_V26A::All") # MONTE CARLO!
...
#                                    destinations = cms.untracked.vstring('detailedInfoMinBias356ReRecoV26A'),
#                                    detailedInfoMinBias356ReRecoV26A = cms.untracked.PSet(
...
process.p = cms.Path(process.noscraping+process.metCorSequence+process.photonFilter+process.ewkElecStandaloneDQM)
