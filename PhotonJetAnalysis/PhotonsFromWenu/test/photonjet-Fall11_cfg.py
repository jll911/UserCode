...
# ---------------------------------------------------------------------
# Fast Jet Rho Correction configuration (photons, from Vgamma) -- just updated version of above?
# ---------------------------------------------------------------------
process.load('RecoJets.Configuration.RecoPFJets_cfi')
process.kt6PFJetsMINE = process.kt6PFJets.clone( doRhoFastjet = True )
process.kt6PFJetsMINE.Rho_EtaMax = cms.double(2.5)

process.TFileService = cms.Service(
    "TFileService",
    fileName = cms.string('photonjet-24Feb12.root')
    )
