...
private:
  ...
  double barrelBoundary_;
  double endcapBoundary_;
  ...
  MonitorElement* refPtNum;
  MonitorElement* refPtDen;
  MonitorElement* refPtEff;
  MonitorElement* refPtIsoNum;
  MonitorElement* refPtIsoDen;
  MonitorElement* refPtIsoEff;
  ...
  MonitorElement* tpgHCALSurrounding;
  MonitorElement* tpgECALSurrounding;
  ...
  void findRegionTowers(const L1GctEmCand& cand,const EcalTrigPrimDigiCollection& ecalDigis, EcalTrigPrimDigiCollection* l1region);//,const L1CaloGeometry* geom ,const  L1CaloEcalScale* scale);
  ...
  public:
	...
	// return whether the difference between a1 and ref(?) cand is less than difference between a2 and ref(?) cand
