...
PREFIXHISTS = "output-RctVal-MINE-"
SUFFIX = ".root"
...
#process.load("DQMServices.Core.DQM_cfg") # BEAUTIFY
...
process.load("Validation.L1Trigger.L1TRCToffline_DataReEmul_v3_cff")
...
#process.load("Configuration.StandardSequences.Geometry_cff") # BEAUTIFY
