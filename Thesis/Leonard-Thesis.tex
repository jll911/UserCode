...
\usepackage[stable]{footmisc} % makes heading footnotes disappear in TOC %% DOESN'T WORK EITHER!!!! WELL, doesn't work with \protect, works if you remove \protect
\usepackage{hyphenat} % break hyphenated words with \hyp{} command
%\usepackage[breaklinks = true]{hyperref} % wrap lines in TOC % CAUSES MAJOR PROBLEMS
