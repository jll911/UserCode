...
%    \includegraphics[width=360pt]{Figures/invMass-04Apr11.png}
  ...
  \caption[Electron-pair invariant mass by $\eta$]{
    ...
    both electrons in the barrel (Fig.~\ref{fig:InvMassEtaDivBarrelBarrel}), 
    one electron each in the barrel and the endcap (Fig.~\ref{fig:InvMassEtaDivBarrelEndcap}),
    and both electrons in the endcap (Fig.~\ref{fig:InvMassEtaDivEndcapEndcap}).
...
%    \begin{tabular}[]{ | l | c | c | }
    \begin{tabular}[]{ | l | c | c | c | c | c | c | c | c | }
      ...
      Supercluster \Et & \multicolumn{2}{|c|}{25} & \multicolumn{2}{|c|}{25} & \multicolumn{2}{|c|}{25} & \multicolumn{2}{|c|}{20}  \\ \hline % 
    \end{tabular}
  \end{center}
\end{table}
...
%    \includegraphics[width=360pt]{Figures/TemplateShapes-01Mar11.png}
%    \includegraphics[width=360pt]{Figures/TemplateShapes-01Mar11-lines.png}
    \subfloat[Barrel-barrel]{\label{fig:ZFitLin}\includegraphics[width=180pt]{Figures/ZFit-lin-08Mar11.png}}
    \subfloat[Barrel-barrel]{\label{fig:ZFitLog}\includegraphics[width=180pt]{Figures/ZFit-log-08Mar11.png}}
  \end{center}
