...
The CMS vector boson analysis team created several different electron selections of varying tightness of cuts,
...
%it is assumed to be a conversion and is rejected.  
 ...
 \begin{figure}[htb]
  ...
  \end{center}
  \caption[\fixspacing Conversion rejection variables after previous cuts]{\fixspacing Conversion rejection variables after previous cuts.}
...
%  \centering
  \begin{center}
    \caption{\fixspacing Thresholds for WP80 relative isolation.}
    \label{TableEisoCuts}
    \begin{tabular}[]{ | l | c | c | }
      \hline
...
%%%% ISOLATION DISTROS
 ...
 \begin{figure}[htb]
  ...
  \end{center}
  \caption[\fixspacing Electron tracker isolation variables before respective cuts]{\fixspacing Electron tracker isolation variables before respective cuts.}
 ...
 \begin{figure}[htb]
  ...
  \end{center}
  \caption[\fixspacing Electron ECAL isolation variables before respective cuts]{\fixspacing Electron ECAL isolation variables before respective cuts.}
 ...
 \begin{figure}[htb]
  ...
  \end{center}
  \caption[\fixspacing Electron HCAL isolation variables before respective cuts]{\fixspacing Electron HCAL isolation variables before respective cuts.}
...
%  \centering
  \begin{center}
    \caption{\fixspacing WP80 electron identification cuts.}
    \label{TableEidCuts}
    \begin{tabular}[]{ | l | c | c | }
      \hline
      Cut variable & Barrel & Endcap  \\ \hline \hline
...
\begin{figure}[htb]
  ...
  \caption[\fixspacing \detain electron identification variables after previous cuts]{
    \fixspacing \detain electron identification variables after previous cuts. 
...
\end{figure}
 ...
 \begin{figure}[htb]
  ...
  \end{center}
    \caption[\fixspacing \dphiin electron identification variables after previous cuts]{
      \fixspacing \dphiin electron identification variables after previous cuts.  
 ...
 \begin{figure}[htb]
  ...
  \end{center}
    \caption[\fixspacing \sieie electron identification variables after previous cuts]{
      \fixspacing \sieie electron identification variables after previous cuts.  
 ...
 \begin{figure}[htb]
  ...
  \end{center}
    \caption[\fixspacing H/E electron identification variables after previous cuts]{
      \fixspacing H/E electron identification variables after previous cuts.  
...
%  \centering
  \begin{center}
    \caption{\fixspacing Criteria for determining acceptance.}
    \label{TableAccCuts}
    \begin{tabular}[]{ | l | c | }
      \hline
...
%  \centering
  \begin{center}
    \caption{\fixspacing Acceptance values.}
...
Therefore it is desirable to use so-called ``data-driven''  %% FIXME ADD REF TO OTHER SECTION
...
\begin{table}[htbp]
  \begin{center}
    \caption{\fixspacing Efficiencies of electron selection steps.}
...
\begin{table}[htbp]
  \begin{center}
    \caption[\fixspacing Efficiencies of data trigger paths]{\fixspacing Efficiencies of all the triggers used in data as determined with the tag-and-probe method.}
