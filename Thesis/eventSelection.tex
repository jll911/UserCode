...
Figures: Reconstructed electron/photon Pt, eta, phi spectra after ID, Fig. \ref{fig:RecoSpectraAfterEid}
 ...
 \begin{figure}[htb]
  \begin{center}
    \includegraphics[width=180pt]{CMS-BW.pdf}
  \end{center}
...
all we have are the events which were not missed.  
...
by applying an additional requirement: 
...
This combined quantity is referred to as 
``ECAL acceptance'' or $A_{ECAL}$.  

The pure kinematic acceptance for this analysis
was determined to be 
BLAH1
and the ECAL acceptance was calculated as 
BLAH2.  
...
Figures: Efficiency table and supporting plots
   ...
   * do trigger effs separately, I guess!  Under trigger section
