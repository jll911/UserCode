...
%it is assumed to be a conversion and is rejected.  
 ...
 \begin{figure}[htb]
  \begin{center}
    ...
    \subfloat[$\Delta\cot\theta$]{\label{fig:DCotConvRejVars}\includegraphics[width=180pt]{Figures/dCotTheta-14Apr11.png}}
    \subfloat[Dist]{\label{fig:DistConvRejVars}\includegraphics[width=180pt]{Figures/dist-14Apr11.png}}
  \end{center}
