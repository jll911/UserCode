...
with a maximum instantaneous luminosity of over 2*10$^{32}$ cm$^{-2}$s$^{-1}$.  % EXPLAIN UNITS SOMEPLACE EARLIER
...
\subsection{Coordinate System} %define eta and phi earlier?
...
to ensure full coverage.  
 ...
 \begin{figure}[htb]
  \begin{center}
    \includegraphics[width=360pt]{Figures/muon-DT-concept.png}
  \end{center}
...
at each station.  
 ...
 \begin{figure}[htb]
  \begin{center}
    \includegraphics[width=360pt]{Figures/muon-CSC-structure.png}
  \end{center}
...
The Regional Calorimeter Trigger (RCT) was designed and built and is maintained 
