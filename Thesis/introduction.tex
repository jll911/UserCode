...
to leptons, at the Z peak.  
The value determined for this was consistently 
around 41.5 nb across the experiments.  
The ratio of hadronic to leptonic decay rates was also calculated, 
...
%  \centering
  \begin{center}
    \caption{Electron-positron Z production cross sections, measured by LEP experiments.}
    \label{TableLep}
%    \begin{tabular}[]{ | l | c | c | }
    \begin{tabular}[]{ | l | l | }
      \hline
