...
theoretical calculation % sridhara
and with other 
%analyses' % sridhara
results to check its validity.  
...
In addition, the agreement demonstrates  % sridhara
the validity of the 
corrections derived from Monte Carlo 
(acceptance and true efficiency).  
...
There are a total of 8453 data events 
%in the plot,   % sridhara
%which makes up the total number of events 
passing 
...
%official 
published % Sridhara
CMS vector boson cross section analysis 
\cite{CMSWZ}  
%calculated 
measured % Sridhara
a value of 992 pb: 
...
The LHC \Zee cross section results are shown along with the Tevatron 
results in Figure~\ref{fig:ResultsWithOthers}, 
as well as the FEWZ NNLO calculation.  
The points are offset horizontally for clarity.  
As discussed in Section~\ref{theory:tevatron}, 
the measurements with CDF and D0 were made at a lower 
center-of-momentum collision energy.  
The increase in cross section with collision energy 
is clearly seen in the figure.  
The fact that the Tevatron measurements were done with 
$p\bar{p}$ collisions instead of $pp$ increases 
the cross section by a slight amount 
relative to $pp$ at the same energy. 

\begin{figure}[htb]
  \begin{center}
    \includegraphics[width=360pt]{Figures/ResultsWithOthersPlot-17Jul11.png}
  \end{center}
  \caption[\fixspacing LHC \Zee cross section results, with Tevatron results and theory]
	  {
	    \fixspacing LHC \Zee cross section results, with Tevatron results and NNLO theory 
	    from FEWZ using MSTW08.  
	    The points are offset horizontally for clarity.  
	  }
	  \label{fig:ResultsWithOthers}
\end{figure}
