...
TH1D * 
myTH1D(std::string name, hBins bins, int lColor, int lWidth, int lStyle, int mStyle )
{
    ...
    if ( name.find ("multiplicity") != std::string::npos )
    {
...
TH1D * 
myTH1D(std::string name, hBins bins, const double *xbins, int lColor, int lWidth, int lStyle, int mStyle )
{
